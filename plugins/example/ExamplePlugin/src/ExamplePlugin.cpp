//##########################################################################
//#                                                                        #
//#                EROWCLOUDVIEWER PLUGIN: ExamplePlugin                   #
//#                                                                        #
...
// 3D views, console, etc.) via the 'm_app' variable (see the ecvMainAppInterface
...
{	
	...
	m_app->dispToConsole( "[ExamplePlugin] Hello world!", ecvMainAppInterface::STD_CONSOLE_MESSAGE );
	
	// Display a warning message in the console
	m_app->dispToConsole( "[ExamplePlugin] Warning: example plugin shouldn't be used as is", ecvMainAppInterface::WRN_CONSOLE_MESSAGE );
	
	// Display an error message in the console AND pop-up an error box
	m_app->dispToConsole( "Example plugin shouldn't be used - it doesn't do anything!", ecvMainAppInterface::ERR_CONSOLE_MESSAGE );
