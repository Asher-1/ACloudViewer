...
namespace Example
{
	...
	void performActionA( ecvMainAppInterface *appInterface )
	{
		...
		appInterface->dispToConsole( "[ExamplePlugin] Hello world!", ecvMainAppInterface::STD_CONSOLE_MESSAGE );
		
		// Display a warning message in the console
		appInterface->dispToConsole( "[ExamplePlugin] Warning: example plugin shouldn't be used as is", ecvMainAppInterface::WRN_CONSOLE_MESSAGE );
		
		// Display an error message in the console AND pop-up an error box
		appInterface->dispToConsole( "Example plugin shouldn't be used - it doesn't do anything!", ecvMainAppInterface::ERR_CONSOLE_MESSAGE );
