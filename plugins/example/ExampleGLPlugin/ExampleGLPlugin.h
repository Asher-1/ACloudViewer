...
//##########################################################################
//#                                                                        #
//#             ErowCloudViewer PLUGIN: ExampleGLPlugin                    #
//#                                                                        #
...
/** Replace 'ExampleGLPlugin' by your own plugin class name throughout and then
	...
	registers your GL filter with ErowCloudViewer.
**/
...
class ExampleGLPlugin : public QObject, public ccGLFilterPluginInterface
{
	...
	Q_PLUGIN_METADATA(IID "cccorp.ErowCloudViewer.plugin.ExampleGL" FILE "info.json")
