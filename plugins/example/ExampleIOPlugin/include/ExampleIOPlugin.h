...
// ##########################################################################
// #                                                                        #
// #          CloudViewer PLUGIN: ExampleIOPlugin                          #
// #                                                                        #
...
itself - the name, authors, maintainers, icon, etc..
        ...
        The one method you are required to implement is getFilters(). This
method registers your file I/O methods with ACloudViewer.
**/
...
class ExampleIOPlugin : public QObject, public ccIOPluginInterface {
    ...
    Q_PLUGIN_METADATA(IID "ecvcorp.cloudviewer.plugin.ExampleIO" FILE
                          "../info.json")
