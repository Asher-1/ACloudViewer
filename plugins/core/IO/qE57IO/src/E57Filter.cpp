...
static bool SaveScan(ccPointCloud* cloud,
    ...
    /// If this vector is empty, it is assumed that all fields will use the
    /// BitPack codec.
...
CC_FILE_ERROR E57Filter::saveToFile(ccHObject* entity,
    ...
    try {
        ...
        /// default namespace). We explicitly register it for completeness (the
        /// reference implementaion would do it for us, if we didn't).
        ...
        /// Really should be a valid WKT string identifying the coordinate
