...
public:
     ...
     **/
    QuaZipFile(const QString &zipName,
     ...
     * by using
     * QuaZipFile(const QString&,const
     *QString&,QuaZip::CaseSensitivity,QObject*) or by calling setFileName().
     *Real name of the file may differ in case if you used case-insensitivity.
     *
     ...
     * to the
     * QuaZipFile(const QString&,const
     *QString&,QuaZip::CaseSensitivity,QObject*), setFileName() or
     *QuaZip::setCurrentFile() - this is the real file name inside archive, so
     *it may differ in case if the file name search was case-insensitive.
     *
     ...
     *device", for which size() should return bytesAvailable() instead. But its
