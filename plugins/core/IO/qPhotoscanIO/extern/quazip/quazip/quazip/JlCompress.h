...
private:
    ...
    static QStringList extractFiles(QuaZip &zip,
    ...
    /**
      ...
      \return true if success, false otherwise.
      */
    static bool compressSubDir(QuaZip *parentZip,
                               QString dir,
                               QString parentDir,
                               bool recursive,
...
public:
    ...
    /**
      ...
      failure.
      */
    static QString extractFile(QString fileCompressed,
                               QString fileName,
    ...
    /**
      ...
      failure.
      */
    static QStringList extractFiles(QString fileCompressed,
                                    QStringList files,
                                    QString dir = QString());
    ...
    /**
      ...
      failure.
      */
    static QString extractFile(QIODevice *ioDevice,
                               QString fileName,
                               QString fileDest = QString());
    /// Extract a list of files.
    /**
