...
set( LASLIB_INCLUDE_DIR "${CMAKE_CURRENT_SOURCE_DIR}/LASlib/inc" CACHE PATH "LASLib include directory" )
set( LASZIP_INCLUDE_DIR "${CMAKE_CURRENT_SOURCE_DIR}/LASzip/src" CACHE PATH "LASZip include directory" )
set( LASLIB_RELEASE_LIBRARY "${CMAKE_CURRENT_SOURCE_DIR}/LASlib/lib/Release/LASlib.lib" CACHE FILEPATH "LASLib release library file" )
set( LASLIB_DEBUG_LIBRARY "${CMAKE_CURRENT_SOURCE_DIR}/LASlib/lib/Debug/LASlib.lib" CACHE FILEPATH "LASLib debug library file" )
