...
| Source      | [trellis-ggml](https://github.com/Asher-1/trellis-ggml) → HF mirror [Asher-1/Trellis2-models](https://huggingface.co/Asher-1/Trellis2-models) (GitHub `trellis2-ggml` release as fallback) |
...
plugin fetches every model (both f16 and q8) from this single source —
...
Primary mirror (single source for all models):

`https://huggingface.co/Asher-1/Trellis2-models/resolve/main/<file>`

Legacy fallback (q8 flow variants only; not queried by the plugin at
runtime):
