...
bool ViewInterpolate::nextView ( cc2DViewportObject& outViewport )
{
    ...
    const ecvViewportParameters& viewParams1 = m_view1->getParameters();
    const ecvViewportParameters& viewParams2 = m_view2->getParameters();
    ecvViewportParameters interpView = m_view1->getParameters();
