...
# ------------------------------------------------------------------------------
	...
	set( CORK_INCLUDE_DIR "cork" CACHE PATH "Cork include directory" )
	set( CORK_RELEASE_LIBRARY_FILE "${CMAKE_CURRENT_SOURCE_DIR}/cork/lib/x64/Release/wincork2013.lib" CACHE FILEPATH "Cork library file (release mode)" )
	if (WIN32)
		set( CORK_DEBUG_LIBRARY_FILE "${CMAKE_CURRENT_SOURCE_DIR}/cork/lib/x64/Debug/wincork2013.lib" CACHE FILEPATH "Cork library file (debug mode)" )
	endif()
	...
	set( MPIR_INCLUDE_DIR "mpir" CACHE PATH "MPIR include directory" )
	set( MPIR_RELEASE_LIBRARY_FILE "${CMAKE_CURRENT_SOURCE_DIR}/mpir/lib/x64/Release/mpir.lib" CACHE FILEPATH "MPIR library file (release mode)" )
	if (WIN32)
		set( MPIR_DEBUG_LIBRARY_FILE "${CMAKE_CURRENT_SOURCE_DIR}/mpir/lib/x64/Debug/mpir.lib" CACHE FILEPATH "MPIR library file (debug mode)" )
	endif()
