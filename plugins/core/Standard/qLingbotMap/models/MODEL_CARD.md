...
| File | Size | Notes |
|---|---|---|
| `lingbot-map-q8.gguf` | 1.21 GiB | **recommended**: near-lossless streaming parity at half the memory |
| `lingbot-map-f16.gguf` | 2.31 GiB | full-alignment format (upstream 286-frame pose 1.72e-04 / depth 4.72e-04 vs the official checkpoint) |
| `lingbot-map-f32.gguf` | 4.63 GiB | exact reference |
| `lingbot-map-q4.gguf` | 703 MiB | experimental (not upstream-validated) |
