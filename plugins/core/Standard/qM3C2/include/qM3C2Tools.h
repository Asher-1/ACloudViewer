...
public:
    ...
    **/
    static bool ComputeCorePointsNormals(
    ...
    //! Re-orients normal vectors so that they all 'look' towards the nearest
    //! point of another cloud
    static bool UpdateNormalOrientationsWithCloud(
