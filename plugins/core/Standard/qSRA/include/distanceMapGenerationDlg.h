...
class DistanceMapGenerationDlg : public QDialog,
                                 public Ui::DistanceMapGenerationDlg {
    Q_OBJECT

public:
    //! Default constructor
    DistanceMapGenerationDlg(ccPointCloud* cloud,
                             ccScalarField* sf,
                             ccPolyline* polyline,
    ...
    DistanceMapGenerationTool::EmptyCellFillOption getEmptyCellFillingOption()
            const;
     ...
     **/
    void getGridXValues(double& minX,
                        double& maxX,
                        double& step,
    ...
    **/
    void getGridYValues(double& minY,
                        double& maxY,
                        double& step,
                        ANGULAR_UNIT unit = ANG_RAD) const;
...
protected:
    ...
    double getSpinboxAngularValue(
            QDoubleSpinBox* spinBox,
            DistanceMapGenerationDlg::ANGULAR_UNIT unit) const;
