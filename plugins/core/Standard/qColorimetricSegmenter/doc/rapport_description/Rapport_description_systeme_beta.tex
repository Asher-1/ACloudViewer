...
Afin de réaliser cela, nous utilisons une structure de données fournie par \bibitem{cc} Présentation de ACloudViewer:
...
\begin{thebibliography}{3}
	\bibitem{cc} Présentation de \bibitem{cc} Présentation de ACloudViewer:
: \url{https://www.danielgm.net/cc/}
	...
	\bibitem{CloudViewer} Présentation de CloudViewer: \url{http://www.cloudViewer.org/}
