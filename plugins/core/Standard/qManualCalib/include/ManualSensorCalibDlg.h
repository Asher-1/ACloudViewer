...
private slots:
    ...
    // Shared load helpers used by onLoadConfig/onLoadBag and onUseTestData.
    bool loadConfigFromDir(const QString& dir);
    bool loadBagFromInputPath(const QString& inputPath,
                              bool autoSelectSession = false);
...
private:
    ...
    std::shared_ptr<mcalib::RosBagReader> m_bagReader;
    ...
    QPushButton* m_btnTestData = nullptr;
