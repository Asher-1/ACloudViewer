...
/// output messages from Python's print to the ACloudViewer console
/// instead of ACloudViewer's stdout & stderr
class ConsoleWrapper
{
  public:
    ...
    /// appears one one line on ACloudViewer's console output
    ///
