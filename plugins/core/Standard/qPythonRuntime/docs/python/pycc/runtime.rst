...
.. important::
    ...
    As the functions and types below allow to interact with the ACloudViewer app,
...
.. autofunction:: pycc.InitQApplication
    ...
    While this is not a problem when in plugin mode as ACloudViewer is the QApplication,
    in stand alone mode it is a problem since ACloudViewer is not running.
...
.. autofunction:: pycc.RunInThread
    ...
    .. code:: Python
        ...
        # if we ran expensive_sum directly, ACloudViewer would
