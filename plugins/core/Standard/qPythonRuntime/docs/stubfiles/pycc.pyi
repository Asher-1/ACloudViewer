...
class ccGenericGLDisplay:
    ...
    """
    LOWER_LEFT_MESSAGE: Any = ...
    UPPER_CENTER_MESSAGE: Any = ...
    SCREEN_CENTER_MESSAGE: Any = ...
    CUSTOM_MESSAGE: Any = ...

    def __init__(self, *args, **kwargs) -> None: ...
    def getUniqueID(self) -> int: ...
    def getTitle(self) -> str: ...
    def redraw(self, only2D: bool = ..., forceRedraw: bool = ...) -> None: ...
    def refresh(self, only2D: bool = ...) -> None: ...
    def toBeRefreshed(self) -> None: ...
    def getViewportParameters(self) -> Any: ...
    def setViewportParameters(self, params: Any) -> None: ...
    def setPerspectiveState(self, state: bool, objectCenteredView: bool, redraw: bool = ...) -> None: ...
    def perspectiveView(self) -> bool: ...
    def objectCenteredView(self) -> bool: ...
    def glWidth(self) -> int: ...
    def glHeight(self) -> int: ...
    def getDevicePixelRatio(self) -> int: ...
    def getOwnDB(self) -> Any: ...
    def addToOwnDB(self, obj: Any, noDependency: bool = ...) -> None: ...
    def removeFromOwnDB(self, obj: Any) -> None: ...
    ...
    def setView(self, orientation: Any) -> None: ...
    def updateConstellationCenterAndZoom(self, box: Any = ...) -> None: ...
    def getCurrentViewDir(self) -> Any: ...
    def moveCamera(self, dx: float, dy: float, dz: float) -> None: ...
    def resetCamera(self) -> None: ...
    def setPivotPoint(self, P: Any, autoRedraw: bool = ..., verbose: bool = ...) -> None: ...
    def renderToFile(self, filename: str, zoomFactor: float = ..., dontScale: bool = ...) -> bool: ...
    def displayNewMessage(self, message: str, pos: Any, append: bool = ..., displayMaxDelay_sec: int = ..., type: Any = ...) -> None: ...
    def setPointSizeOnView(self, size: float) -> None: ...
    def setViewportDefaultPointSize(self, size: float) -> None: ...
    def setViewportDefaultLineWidth(self, width: float) -> None: ...
    def getLightIntensity(self) -> float: ...
    def setLightIntensity(self, intensity: float) -> None: ...
