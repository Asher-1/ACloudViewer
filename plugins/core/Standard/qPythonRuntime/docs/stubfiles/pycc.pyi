...
class _NormsIndexesArrayType(_VectorCompressedNormType, cvcorelib.CCShareable, ccHObject):
    def __init__(self, *args, **kwargs) -> None: ...
...
class __ccGenericPointCloudTpl(ccGenericPointCloud):
    def __init__(self, *args, **kwargs) -> None: ...
    def addPoint(self, P: cvcorelib.CCVector3) -> None: ...
    ...
    def forEach(self, action: Callable[[cvcorelib.CCVector3,float],None]) -> None: ...
    def getBoundingBox(self, bbMin: cvcorelib.CCVector3, bbMax: cvcorelib.CCVector3) -> None: ...
    def getCurrentInScalarField(self) -> cvcorelib.ScalarField: ...
    def getCurrentInScalarFieldIndex(self) -> int: ...
    def getCurrentOutScalarField(self) -> cvcorelib.ScalarField: ...
    def getCurrentOutScalarFieldIndex(self) -> int: ...
    def getNextPoint(self) -> cvcorelib.CCVector3: ...
    def getNumberOfScalarFields(self) -> int: ...
    def getPointScalarValue(self, pointIndex: int) -> float: ...
    def getScalarField(self, index: int) -> cvcorelib.ScalarField: ...
...
class cc2DLabel(ccHObject, ccInteractor):
    ...
    @overload
    def addPickedPoint(self, cloud: ccGenericMesh, triangleIndex: int, uv: cvcorelib.CCVector2d, entityCenter: bool = ...) -> bool: ...
    @overload
...
class ccBox(ccGenericPrimitive):
    def __init__(self, dims: cvcorelib.CCVector3, transMat: ccGLMatrix = ..., name: QString = ...) -> None: ...
    def getDimensions(self) -> cvcorelib.CCVector3: ...
    def setDimensions(self, dims: cvcorelib.CCVector3) -> None: ...
...
class ccCone(ccGenericPrimitive):
    ...
    def getBottomCenter(self) -> cvcorelib.CCVector3: ...
    def getBottomRadius(self) -> float: ...
    def getHeight(self) -> float: ...
    def getLargeCenter(self) -> cvcorelib.CCVector3: ...
    def getLargeRadius(self) -> float: ...
    def getSmallCenter(self) -> cvcorelib.CCVector3: ...
    def getSmallRadius(self) -> float: ...
    def getTopCenter(self) -> cvcorelib.CCVector3: ...
...
class ccDrawableObject:
    ...
    def isColorOverridden(self) -> bool: ...
    ...
    def translateGL(self, rotMat: cvcorelib.CCVector3) -> None: ...

class ccGLCameraParameters:
    def __init__(self) -> None: ...
    @overload
    def project(self, input3D: cvcorelib.CCVector3d, output2D: cvcorelib.CCVector3d, checkInFrustrum: bool = ...) -> bool: ...
    @overload
    def project(self, input3D: cvcorelib.CCVector3, output2D: cvcorelib.CCVector3d, checkInFrustrum: bool = ...) -> bool: ...
    @overload
    def project(*args, **kwargs) -> Any: ...
    @overload
    def unproject(self, input3D: cvcorelib.CCVector3d, output2D: cvcorelib.CCVector3d) -> bool: ...
    @overload
    def unproject(self, input3D: cvcorelib.CCVector3, output2D: cvcorelib.CCVector3d) -> bool: ...
    @overload
...
class ccGenericGLDisplay:
    ...
    def display3DLabel(self, str: QString, pos3D: cvcorelib.CCVector3, color: Rgba = ..., font: QFont = ...) -> None: ...
...
class ccGenericMesh(cvcorelib.GenericIndexedMesh, ccHObject):
    def __init__(self, *args, **kwargs) -> None: ...
...
class ccGenericPointCloud(ccShiftedObject, cvcorelib.GenericIndexedCloudPersist):
    def __init__(self, *args, **kwargs) -> None: ...
...
class ccInteractor:
    ...
    def move3D(self, u: cvcorelib.CCVector3d) -> bool: ...
...
class ccPlanarEntityInterface:
    def __init__(self, *args, **kwargs) -> None: ...
    def getNormal(self) -> cvcorelib.CCVector3: ...
...
class ccPlane(ccGenericPrimitive, ccPlanarEntityInterface):
    ...
    def flip(self) -> None: ...
    def getCenter(self) -> cvcorelib.CCVector3: ...
...
class ccPointCloud(__ccGenericPointCloudTpl):
    ...
    def partialClone(self, reference: cvcorelib.ReferenceCloud, warnings: int = ...) -> ccPointCloud: ...
...
class ecvProgressDialog(QProgressDialog, cvcorelib.GenericProgressCallback):
