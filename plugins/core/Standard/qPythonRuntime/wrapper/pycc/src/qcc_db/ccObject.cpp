...
void define_ccObject(py::module &m)
{
    ...
    The base class of all ACloudViewer's data types
    ...
    key: str
        ...
        .def(
            "setMetaData",
            [](ccObject &obj, const QString &key, const QVariant &data)
    ...
    Returns the recursive number of children
        ...
        // bounding-box
        .def("getDisplayBB_recursive", &ccHObject::getDisplayBB_recursive, "relative"_a)
