...
void define_cc2DLabel(py::module &m)
{
    ...
    Pycc2DLabel.def(
        "clear", &cc2DLabel::clear, "ignoreDependencies"_a = false, "ignoreCaption"_a = true);
    ...
    py::class_<cc2DLabel::PickedPoint>(Pycc2DLabel, "PickedPoint")
        .def_readwrite("_cloud", &cc2DLabel::PickedPoint::cloud, py::return_value_policy::reference)
        .def_readwrite("_mesh", &cc2DLabel::PickedPoint::mesh, py::return_value_policy::reference)
