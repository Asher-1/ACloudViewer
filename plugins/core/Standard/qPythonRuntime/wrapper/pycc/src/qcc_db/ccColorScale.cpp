...
void define_ccColorScale(py::module &m)
{
    ...
    pyColorScale.def(py::init<const QString &, const QString &>(), "name"_a, "uuid"_a = QString())
        ...
        .def("getColorByRelativePos",
             static_cast<const ecvColor::Rgb *(ccColorScale::*)(double, const ecvColor::Rgb *)
                             const>(&ccColorScale::getColorByRelativePos),
             "relativePos"_a,
             "outOfRangeColor"_a = nullptr)
        .def("getColorByRelativePos",
             static_cast<const ecvColor::Rgb *(
                 ccColorScale::*)(double, unsigned, const ecvColor::Rgb *) const>(
