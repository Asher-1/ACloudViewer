...
{
    py::class_<cloudViewer::SimpleRefTriangle, cloudViewer::GenericTriangle>(cccorelib, "SimpleRefTriangle")
        .def(py::init<>())
    ...
    py::class_<cloudViewer::SimpleTriangle, cloudViewer::GenericTriangle>(cccorelib, "SimpleTriangle")
        .def(py::init<>())
