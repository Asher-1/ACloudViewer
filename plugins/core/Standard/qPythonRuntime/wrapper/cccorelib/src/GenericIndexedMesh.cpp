...
{
    py::class_<cloudViewer::VerticesIndexes>(cccorelib, "VerticesIndexes")
        .def(py::init<>())
    ...
    py::class_<cloudViewer::GenericIndexedMesh, cloudViewer::GenericMesh>(cccorelib, "GenericIndexedMesh")
        .def("_getTriangle",
