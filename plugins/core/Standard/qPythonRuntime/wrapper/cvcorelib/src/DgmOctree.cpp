...
using cloudViewer::DgmOctree;

#include "cvcorelib.h"

void define_DgmOctree(py::module &cvcorelib)
{
    py::class_<DgmOctree, cloudViewer::GenericOctree> PyDgmOctree(cvcorelib, "DgmOctree");
    ...
    PyDgmOctree.def_static("GET_BIT_SHIFT", &DgmOctree::GET_BIT_SHIFT, "level"_a)
        ...
        .def(
            "build",
            [](DgmOctree &self, cloudViewer::GenericProgressCallback *progressCb = nullptr)
            { return self.build(); },
