...
void define_AutoSegmentationTools(py::module &cvcorelib)
{
    py::class_<cloudViewer::AutoSegmentationTools> AutoSegmentationTools(cvcorelib, "AutoSegmentationTools");
