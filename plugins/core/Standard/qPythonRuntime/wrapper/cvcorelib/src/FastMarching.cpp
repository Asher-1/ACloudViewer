...
void define_FastMarching(py::module &cvcorelib)
{
    cvcorelib.attr("c_FastMarchingNeighbourPosShift") = cloudViewer::c_FastMarchingNeighbourPosShift;
    py::class_<cloudViewer::FastMarching>(cvcorelib, "FastMarching")
