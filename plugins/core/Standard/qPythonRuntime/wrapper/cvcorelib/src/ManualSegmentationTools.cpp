...
void define_ManualSegmentationTools(py::module &cvcorelib)
{
    using cloudViewer::ManualSegmentationTools;

    py::class_<ManualSegmentationTools> PyManualSegmentationTools(cvcorelib, "ManualSegmentationTools");
    ...
    PyManualSegmentationTools
        .def_static(
            ...
            (cloudViewer::ReferenceCloud *
             (*)(cloudViewer::GenericIndexedCloudPersist *, const cloudViewer::Polyline *, bool, const float *))(
        ...
        .def_static("segment",
                    (cloudViewer::ReferenceCloud *
                     (*)(cloudViewer::GenericIndexedCloudPersist *, ScalarType, ScalarType, bool))(
                        &ManualSegmentationTools::segment),
                    "cloud"_a,
                    "minDist"_a,
                    "maxDist"_a,
        ...
        .def_static("isPointInsidePoly",
                    (bool (*)(const CCVector2 &, const cloudViewer::GenericIndexedCloud *))(
