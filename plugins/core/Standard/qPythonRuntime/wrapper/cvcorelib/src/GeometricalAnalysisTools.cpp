...
using cloudViewer::GeometricalAnalysisTools;

void define_GeometricalAnalysisTools(py::module &cvcorelib)
{
    py::class_<GeometricalAnalysisTools> GeometricalAnalysisTools(cvcorelib, "GeometricalAnalysisTools");
