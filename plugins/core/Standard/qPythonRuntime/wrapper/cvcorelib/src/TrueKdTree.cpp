...
using cloudViewer::TrueKdTree;

void define_TrueKdTree(py::module &cvcorelib)
{

    py::class_<TrueKdTree> PyTrueKdTree(cvcorelib, "TrueKdTree");
    ...
    PyTrueKdTree
        ...
        .def(py::init<cloudViewer::GenericIndexedCloudPersist *>(), "cloud"_a)
        .def("associatedCloud", &TrueKdTree::associatedCloud, py::return_value_policy::reference)
        .def("build",
             &TrueKdTree::build,
             "maxError"_a,
             "errorMeasure"_a = cloudViewer::DistanceComputationTools::RMS,
    ...
    PyLeaf
        ...
        .def(py::init(
                 [](cloudViewer::ReferenceCloud *set, const py::sequence &planeEquation, ScalarType error)
                 {
