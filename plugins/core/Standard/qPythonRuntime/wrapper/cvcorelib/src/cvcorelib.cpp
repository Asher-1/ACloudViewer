...
void define_ScalarField(py::module &cvcorelib);

void define_ScalarFieldTools(py::module &cvcorelib);

void define_RegistrationTools(py::module &cvcorelib);

void define_ReferenceCloud(py::module &cvcorelib);

void define_Polyline(py::module &cvcorelib);

void define_PointProjectionTools(py::module &cvcorelib);

void define_GenericIndexedCloudPersist(py::module &cvcorelib);

void define_PointCloud(py::module &cvcorelib);

void define_GenericOctree(py::module &cvcorelib);

void define_KdTree(py::module &cvcorelib);
...
class NumpyCloud : public cloudViewer::GenericIndexedCloud
{
  public:
...
void define_cccorelib(py::module &m)
{
    ...
    define_Polyline(m);
    py::bind_vector<cloudViewer::ReferenceCloudContainer>(m, "ReferenceCloudContainer");
    ...
    py::class_<NumpyCloud, cloudViewer::GenericIndexedCloud, cloudViewer::GenericCloud>(m, "NumpyCloud")
...
PYBIND11_EMBEDDED_MODULE(cvcorelib, m)
{
    define_cccorelib(m);
}
#else
PYBIND11_MODULE(cvcorelib, m)
{
    define_cccorelib(m);
}
#endif
