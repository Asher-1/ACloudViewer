...
{
    py::class_<cloudViewer::ScalarField, CCShareable, CCShareableHolder<cloudViewer::ScalarField>>(cvcorelib,
                                                                                               "ScalarField",
                                                                                               R"doc(
    ScalarField

    .. note::
        Note that cvcorelib.ScalarField uses float while Python only uses doubles
        which means a loss of precision will happen.

    Getting / Setting values can be done via :meth:`cvcorelib.ScalarField.getValue`
    or :meth:`cvcorelib.ScalarField.setValue`.
    Alternatively, it is possible to use bracket operator.

    Use :meth:`cvcorelib.ScalarField.asArray` to be able to use the
    ...
    .. code:: Python
        ...
        scalar_field = cvcorelib.ScalarField("Codification")
)doc")
    ...
    You need to call :meth:`cvcorelib.ScalarField.computeMinAndMax` if the array has changed
    since last call.
)doc")
    ...
    Prefer use of :meth:`cvcorelib.ScalarField.reserve`.
)doc")
        .def(
            "resize",
    ...
    Prefer use of :meth:`cvcorelib.ScalarField.resize`.
)doc")
        .def("getValue",
