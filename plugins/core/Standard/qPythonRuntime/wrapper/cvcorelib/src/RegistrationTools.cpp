...
{
    py::class_<cloudViewer::RegistrationTools> RegistrationTools(cvcorelib, "RegistrationTools");
    ...
    py::class_<cloudViewer::HornRegistrationTools, cloudViewer::RegistrationTools>(cvcorelib,
                                                                               "HornRegistrationTools")
    ...
    py::class_<cloudViewer::ICPRegistrationTools, cloudViewer::RegistrationTools> ICPRegistrationTools(
        cvcorelib, "ICPRegistrationTools");
    ...
    py::class_<cloudViewer::FPCSRegistrationTools, cloudViewer::RegistrationTools>(cvcorelib,
                                                                               "FPCSRegistrationTools")
