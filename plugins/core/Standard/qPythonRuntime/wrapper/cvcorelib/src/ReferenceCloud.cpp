...
{
    py::class_<ReferenceCloud, cloudViewer::GenericIndexedCloudPersist>(cvcorelib, "ReferenceCloud")
        .def(py::init<cloudViewer::GenericIndexedCloudPersist *>(), "associatedCloud"_a, py::keep_alive<1, 2>())
