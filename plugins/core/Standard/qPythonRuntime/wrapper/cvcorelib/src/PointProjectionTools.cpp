...
void define_PointProjectionTools(py::module &cvcorelib)
{
    ...
    py::enum_<cloudViewer::TRIANGULATION_TYPES>(cvcorelib, "TRIANGULATION_TYPES")
    ...
    py::class_<cloudViewer::SquareMatrixTpl<double>> PySquareMatrixd(cvcorelib, "SquareMatrixd");

    py::class_<PointProjectionTools> PyPointProjectionTools(cvcorelib, "PointProjectionTools");
