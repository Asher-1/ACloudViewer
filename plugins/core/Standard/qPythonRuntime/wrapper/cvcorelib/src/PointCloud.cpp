...
void define_PointCloud(py::module &cvcorelib)
{
    ...
    DEFINE_POINTCLOUDTPL(GenericIndexedCloudPersist, cvcorelib, "__pointCloudTplCCCoreLib");
    py::class_<PointCloud, cloudViewer::PointCloudTpl<GenericIndexedCloudPersist>>(cvcorelib, "PointCloud")
        .def(py::init<>())
