...
void define_CCMiscTools(py::module &cvcorelib)
{
    py::class_<cloudViewer::CCMiscTools> CCMiscTools(cvcorelib, "CCMiscTools");
    ...
    CCMiscTools.def_static(
        "ComputeBaseVectors",
        (void (*)(const CCVector3 &, CCVector3 &, CCVector3 &))(&cloudViewer::CCMiscTools::ComputeBaseVectors),
        "N"_a,
        "X"_a,
        "Y"_a);
