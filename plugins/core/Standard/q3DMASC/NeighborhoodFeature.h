...
public:  // NeighborhoodFeatureType
    ...
    static inline NeighborhoodFeatureType FromString(const QString& token) {
...
public:  // members
    ...
    //! Feature values
    cloudViewer::ScalarField *sf1, *sf2;
};
}  // namespace masc
