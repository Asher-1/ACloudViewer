...
void ccMeasurementRecorder::loadFittingPoints()
{
	...
	m_fittingPointFolder->filterChildren(fittingPointLabels, false, CV_TYPES::LABEL_2D);
...
void ccMeasurementRecorder::loadMeasurementPoints()
{
	...
	m_measurementFolder->filterChildren(measurementLabels, false, CV_TYPES::LABEL_2D);
