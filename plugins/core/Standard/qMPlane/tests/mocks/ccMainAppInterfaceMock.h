...
public:
    ...
    MAKE_MOCK2(registerOverlayDialog,
               void(ccOverlayDialog*, Qt::Corner),
               override);
    ...
    MAKE_MOCK1(removeObjectTemporarilyFromDBTree,
               ccHObjectContext(ccHObject*),
               override);
    MAKE_MOCK2(putObjectBackIntoDBTree,
               void(ccHObject*, const ccHObjectContext&),
               override);
    MAKE_MOCK2(setSelectedInDB, void(ccHObject*, bool), override);
    MAKE_CONST_MOCK0(getSelectedEntities,
    ...
    MAKE_MOCK5(spawnHistogramDialog,
               void(const std::vector<unsigned>&,
                    double,
                    double,
                    QString,
                    QString),
