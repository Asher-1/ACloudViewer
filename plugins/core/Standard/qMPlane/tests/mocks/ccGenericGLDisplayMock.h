...
public:
    ...
    MAKE_CONST_MOCK0(getViewportParameters,
                     const ecvViewportParameters&(),
                     override);
    MAKE_MOCK5(setupProjectiveViewport,
               void(const ccGLMatrixd&, float, float, bool, bool),
               override);
