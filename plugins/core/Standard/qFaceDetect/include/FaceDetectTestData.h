...
/** Curated gallery frontal enrollment photo for FriendsFaces cast
 * (gallery/Name/…). */
...
/** QSettings key for the active face registry DB (legacy; prefer
 * manualRegistryDbSettingsKey). */
...
/** Group photo for Detect/Analyze/Dense batch test data (never a cropped
 * portrait). */
