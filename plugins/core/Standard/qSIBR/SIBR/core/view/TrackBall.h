...
public:
    ...
    **/
    void fromCamera(const InputCamera& cam,
    ...
    */
    ...
    \param viewport the view viewport
    */
    bool fromBoundingBox(const Eigen::AlignedBox<float, 3>& box,
                         const Viewport& viewport);

    /** Update the trackball handler state. the raycaster is used when the user
       is clicking to center the trackball or panning. \param input user input
    ...
    */
    ...
    \param viewport view viewport
    */
    virtual void update(const sibr::Input& input,
...
private:
    ...
    */
    void updateBallCenter(const Input& input,
                          std::shared_ptr<Raycaster> raycaster);
    ...
    */
    void updateTranslationPlane(const Input& input,
                                const Viewport& viewport,
                                std::shared_ptr<Raycaster> raycaster =
                                        std::shared_ptr<Raycaster>());
    ...
    */
    bool isInTrackBall2dRegion(const Vector2i& pos2D,
     ...
     */
    bool areClockWise(const Vector2f& a,
                      const Vector2f& b,
    ...
    */
    ...
    /** Main update function.
      ...
      \param raycaster optional scene raycaster
    */
    void updateTrackBallCamera(const Input& input,
                               const Viewport& viewport,
                               std::shared_ptr<Raycaster> raycaster =
                                       std::shared_ptr<Raycaster>());
    ...
    Eigen::Hyperplane<float, 3>
            trackballPlane;  ///< Trackball translation plane.
