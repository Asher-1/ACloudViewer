...
float Intersector2D::sign(sibr::Vector2f p1,
                          sibr::Vector2f p2,
                          sibr::Vector2f p3) {
...
bool Intersector2D::PointInTriangle(sibr::Vector2f pt,
                                    sibr::Vector2f v1,
                                    sibr::Vector2f v2,
                                    sibr::Vector2f v3) {
    bool b1, b2, b3;
...
bool Intersector2D::LineLineIntersect(sibr::Vector2f a,
                                      sibr::Vector2f b,
                                      sibr::Vector2f c,
                                      sibr::Vector2f d) {
    float den = ((d.y() - c.y()) * (b.x() - a.x()) -
                 (d.x() - c.x()) * (b.y() - a.y()));
    float num1 = ((d.x() - c.x()) * (a.y() - c.y()) -
                  (d.y() - c.y()) * (a.x() - c.x()));
    float num2 = ((b.x() - a.x()) * (a.y() - c.y()) -
                  (b.y() - a.y()) * (a.x() - c.x()));
    float u1 = num1 / den;
    float u2 = num2 / den;
...
bool Intersector2D::TriTriIntersect(sibr::Vector2f t0_0,
                                    sibr::Vector2f t0_1,
                                    sibr::Vector2f t0_2,
                                    sibr::Vector2f t1_0,
                                    sibr::Vector2f t1_1,
    ...
    if (LineLineIntersect(t0_0, t0_1, t1_0, t1_1)) {
        return true;
    };
    if (LineLineIntersect(t0_0, t0_1, t1_0, t1_2)) {
        return true;
    };
    if (LineLineIntersect(t0_0, t0_1, t1_1, t1_2)) {
        return true;
    };
    if (LineLineIntersect(t0_0, t0_2, t1_0, t1_1)) {
        return true;
    };
    if (LineLineIntersect(t0_0, t0_2, t1_0, t1_2)) {
        return true;
    };
    if (LineLineIntersect(t0_0, t0_2, t1_1, t1_2)) {
        return true;
    };
    if (LineLineIntersect(t0_1, t0_2, t1_0, t1_1)) {
        return true;
    };
    if (LineLineIntersect(t0_1, t0_2, t1_0, t1_2)) {
        return true;
    };
    if (LineLineIntersect(t0_1, t0_2, t1_1, t1_2)) {
        return true;
    };
...
bool Intersector2D::QuadQuadIntersect(sibr::Vector2f q0_0,
                                      sibr::Vector2f q0_1,
                                      sibr::Vector2f q0_2,
                                      sibr::Vector2f q0_3,
                                      sibr::Vector2f q1_0,
                                      ...
                                      sibr::Vector2f q1_2,
                                      sibr::Vector2f q1_3) {
    if (TriTriIntersect(q0_0, q0_1, q0_3, q1_0, q1_1, q1_3)) {
        return true;
    }
    if (TriTriIntersect(q0_0, q0_1, q0_3, q1_1, q1_2, q1_3)) {
        return true;
    }
    if (TriTriIntersect(q0_1, q0_2, q0_3, q1_0, q1_1, q1_3)) {
        return true;
    }
    if (TriTriIntersect(q0_1, q0_2, q0_3, q1_1, q1_2, q1_3)) {
        return true;
    }
...
std::vector<std::vector<bool>> Intersector2D::frustrumQuadsIntersect(
        std::vector<quad>& quads, const std::vector<InputCamera::Ptr>& cams) {
    std::clock_t previous;
    double duration;
    previous = std::clock();

    std::vector<std::vector<bool>> result(
            cams.size(), std::vector<bool>(quads.size(), false));
    ...
    for (int c = 0; c < cams.size(); c++) {
        ...
        for (int q = 0; q < quads.size(); q++) {
            ...
            std::shared_ptr<sibr::Mesh> quadMesh =
                    std::shared_ptr<sibr::Mesh>(new sibr::Mesh(true));
            ...
            int indices[12] = {
                    0, 1, 2, 0, 2, 3, 1,
                    2, 3, 0, 1, 3};  // triangle added, can be optimized if quad
                                     // ensured with good order
            ...
            quadMesh->render(false, false,
                             sibr::Mesh::RenderMode::FillRenderMode);
