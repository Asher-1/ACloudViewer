...
struct PointBasedAppArgs : virtual BasicIBRAppArgs {
...
int main(int ac, char** av) {
    {
        ...
        PointBasedView::Ptr pointbasedView(
                new PointBasedView(scene, sceneResWidth, sceneResHeight));
        ...
        multiViewManager.addIBRSubView("Point-Based View", pointbasedView,
                                       usedResolution,
