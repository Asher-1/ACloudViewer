...
void ccAutoSeg::doAction()
{
	...
	if (checkMortar == true && checkSegment == false) {
		m_app->dispToConsole("Segmentation is required for the creation of mortar maps. Please, check both \"Automatic segmentation\" and \"Mortar maps\".", ecvMainAppInterface::ERR_CONSOLE_MESSAGE);
		return;
	}
