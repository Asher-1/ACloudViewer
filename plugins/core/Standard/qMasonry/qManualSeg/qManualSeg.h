...
class ccManualSeg : public QObject, public ccStdPluginInterface {
    ...
    Q_PLUGIN_METADATA(IID "ecvcorp.cloudviewer.plugin.qManualSeg" FILE
                          "info.json")
...
private:
    ...
    std::vector<int> stIdFromPtId(std::vector<int> pts,
                                  std::vector<std::pair<int, int>> pairs);
    std::vector<int> ptIdFromStId(std::vector<int> pts,
                                  std::vector<std::pair<int, int>> pairs);
