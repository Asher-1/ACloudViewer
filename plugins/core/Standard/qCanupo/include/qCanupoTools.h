...
public:
    ...
    /** \return true if both are 'equivalent' (i.e. same number of values,
     *almost same values, same order)
     **/
    ...
    //! Returns the cloud associated to the currently selected item of a combox
    //! box
    /** Relies on the item associated data (itemData) that should be equal to
     *the cloud's ID.
     **/
