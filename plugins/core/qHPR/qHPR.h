...
class qHPR : public QObject, public ccStdPluginInterface
{
	...
	Q_PLUGIN_METADATA(IID "ecvcorp.cloudviewer.plugin.qHPR" FILE "info.json")
...
protected:
	...
	CVLib::ReferenceCloud* removeHiddenPoints(CVLib::GenericIndexedCloudPersist* theCloud, const CCVector3d& viewPoint, double fParam);

	//! Associated action
	QAction* m_action;
};

#endif // Q_HPR_PLUGIN_HEADER
