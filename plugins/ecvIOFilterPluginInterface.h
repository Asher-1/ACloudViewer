...
#ifndef ECV_IO_FILTER_PLUGIN_INTERFACE_HEADER
#define ECV_IO_FILTER_PLUGIN_INTERFACE_HEADER
...
public:
	...
	virtual CC_PLUGIN_TYPE getType() const { return ECV_IO_FILTER_PLUGIN; }
...
Q_DECLARE_INTERFACE(ccIOFilterPluginInterface,
                    "edf.rd.CloudViewer.ccIOFilterPluginInterface/1.1")

#endif // ECV_IO_FILTER_PLUGIN_INTERFACE_HEADER
