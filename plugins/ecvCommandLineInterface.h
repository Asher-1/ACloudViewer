...
public: //virtual methods
	...
	**/
	...
	virtual ecvProgressDialog* progressDialog() { return nullptr; }
...
public: //Global shift management
	...
	void storeCoordinatesShiftParams() { 
		m_coordinatesShiftWasEnabled = m_loadingParameters.m_coordinatesShiftEnabled; 
		m_formerCoordinatesShift = m_loadingParameters.m_coordinatesShift; 
	}
	...
	**/
	bool processGlobalShiftCommand()
	{
		...
		if (firstParam.toUpper() == COMMAND_OPEN_SHIFT_ON_LOAD_AUTO())
		{
			...
			m_loadingParameters.shiftHandlingMode = ecvGlobalShiftManager::NO_DIALOG_AUTO_SHIFT;
		}
