...
ExternalProject_Add(
    ext_faiss
    PREFIX faiss
    URL https://github.com/intel-isl/faiss/archive/28ef0e0fa5b99dabb371df9016a7df3e836a31f4.tar.gz # cloudViewer_patch branch
    ...
    BUILD_BYPRODUCTS
        ${MKL_INSTALL_PREFIX}/${CloudViewer_INSTALL_LIB_DIR}/${CMAKE_STATIC_LIBRARY_PREFIX}faiss${CMAKE_STATIC_LIBRARY_SUFFIX}
)

set(FAISS_LIBRARIES faiss)
set(FAISS_INCLUDE_DIR "${MKL_INSTALL_PREFIX}/include/")
set(FAISS_LIB_DIR "${MKL_INSTALL_PREFIX}/${CloudViewer_INSTALL_LIB_DIR}")  # Must have no trailing "/".
