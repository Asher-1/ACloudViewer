...
if (APPLE)
    set(WEBRTC_URL
        https://github.com/Asher-1/cloudViewer_downloads/releases/download/1.2.0/webrtc_${WEBRTC_VER}_macos_10.14.tar.gz
    )
...
#    if (BUILD_SHARED_LIBS OR NOT STATIC_WINDOWS_RUNTIME)
	...
	if (STATIC_WINDOWS_RUNTIME)
	    set(WEBRTC_URL https://github.com/Asher-1/cloudViewer_downloads/releases/download/1.2.0/webrtc_${WEBRTC_VER}_win.zip)
    ...
    if(GLIBCXX_USE_CXX11_ABI)
        set(WEBRTC_URL
            https://github.com/Asher-1/cloudViewer_downloads/releases/download/1.2.0/webrtc_${WEBRTC_VER}_cxx-abi-1.tar.gz
        )
        set(WEBRTC_SHA256 0d98ddbc4164b9e7bfc50b7d4eaa912a753dabde0847d85a64f93a062ae4c335)
    else()
        set(WEBRTC_URL
            https://github.com/Asher-1/cloudViewer_downloads/releases/download/1.2.0/webrtc_${WEBRTC_VER}_cxx-abi-0.tar.gz
        )
...
ExternalProject_Add(ext_webrtc
    ...
    DOWNLOAD_DIR "${CLOUDVIEWER_THIRD_PARTY_DOWNLOAD_DIR}/webrtc"
    UPDATE_COMMAND ""
    CONFIGURE_COMMAND ""
    BUILD_COMMAND ""
    INSTALL_COMMAND ""
...
set(LIBPNG_LIB_DIR ${INSTALL_DIR}/${CloudViewer_INSTALL_LIB_DIR})
