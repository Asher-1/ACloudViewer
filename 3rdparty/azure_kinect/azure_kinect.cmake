...
function(find_k4a_with_ubuntu_1604_pip_package)
    ...
    if (LSB_RELEASE_EXEC)
        ...
        if(LSB_DISTRIBUTION STREQUAL "Ubuntu" AND LSB_CODENAME STREQUAL "xenial")
            message(STATUS "Ubuntu 16.04 detected, trying to load from cloudViewer-azure-kinect-ubuntu1604 pip package")
            ...
            message(STATUS "Not Ubuntu 16.04, skipping cloudViewer-azure-kinect-ubuntu1604 pip package load")
        endif()
    else()
...
if (BUILD_AZURE_KINECT)
    # Conditionally include header files in cloudViewer.h
    ...
    if (WIN32)
        ...
        # Attempt 2: "cloudViewer-azure-kinect-ubuntu1604"
        # User need to run `pip install cloudViewer-azure-kinect-ubuntu1604` first.
