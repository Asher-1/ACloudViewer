...
#include <sam3d_spconv/sam3d/spconv/Ampere_f16f16f16f16f16tnt_m128n64k32m64n32k32A1T1688_200_C301LLL_SK/mma/mma_ns_wb/layout/MyTensorOpLayout.h>
...
using Layout = sam3d_spconv::sam3d::spconv::Ampere_f16f16f16f16f16tnt_m128n64k32m64n32k32A1T1688_200_C301LLL_SK::mma::mma_ns_wb::layout::MyTensorOpLayout;
struct SmemTileIterator {
  ...
  __forceinline__ __device__ void store_with_byte_offset(tv::array<tv::half_t, 16, 0> const& frag, int32_t byte_offset)   {
