...
if(GGML_USE_CUDA)
    ...
    _ggml_read_synced_cache(GGML_USE_CUDNN BOOL OFF
        "Internal: synced from AICore_USE_CUDNN")
    if(GGML_USE_CUDNN)
        list(APPEND GGML_CMAKE_ARGS -DGGML_CUDA_USE_CUDNN=ON)
        message(STATUS "ggml: cuDNN conv2d enabled")
    else()
        list(APPEND GGML_CMAKE_ARGS -DGGML_CUDA_USE_CUDNN=OFF)
    endif()
