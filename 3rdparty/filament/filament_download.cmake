...
if (FILAMENT_PRECOMPILED_ROOT)
    ...
    elseif(APPLE)
    ...
    else()      # Linux: Check glibc version and use cloudViewer filament binary if new (Ubuntu 20.04 and similar)
        ...
        if(${glibc_version} VERSION_LESS "2.31")
            ...
            set(DOWNLOAD_URL_PRIMARY
                "https://storage.googleapis.com/cloudViewer-releases/filament/filament-v1.9.5-linux.tgz")
            message(STATUS "GLIBC version ${glibc_version} found: Downloading "
