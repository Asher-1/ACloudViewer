...
// This allows app to reuse the implementation from libs/Reconstruction
...
// app-specific wrapper that extends colmap's AutomaticReconstructionController
// Main additions:
...
public:
    // Extend Options with app-specific settings
