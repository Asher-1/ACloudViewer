...
RenderOptionsWidget::RenderOptionsWidget(QWidget* parent,
    ...
    grid_layout_->addWidget(select_background_color,
    ...
    AddOptionDouble(&point3D_colormap_min_q_, "Point colormap minq", 0, 1,
                    0.001, 3);
    AddOptionDouble(&point3D_colormap_max_q_, "Point colormap maxq", 0, 1,
                    0.001, 3);
    AddOptionDouble(&point3D_colormap_scale_, "Point colormap scale", -1e7,
                    1e7);
    ...
    AddOptionBool(&options->render->adapt_refresh_rate,
...
void RenderOptionsWidget::ImageColormapNameFilterAddWord() {
    ...
    const QString word = QInputDialog::getText(
            this, "", "Word:", QLineEdit::Normal, "", &word_ok);
    if (!word_ok || word == "") {
        return;
    }
