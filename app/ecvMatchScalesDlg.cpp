...
ccMatchScalesDlg::ccMatchScalesDlg(const ccHObject::Container& entities,
                                   ...
                                   QWidget* parent /*=0*/)
    : QDialog(parent, Qt::Tool), Ui::MatchScalesDialog() {
    setupUi(this);
    ...
    for (size_t i = 0; i < entities.size(); ++i) {
        ...
        listWidget->insertItem(
                static_cast<int>(i),
                new QListWidgetItem(QString("%1 (ID=%2)")
    ...
    rmsDifferenceLineEdit->setValidator(
...
void ccMatchScalesDlg::setSelectedAlgorithm(
...
ccLibAlgorithms::ScaleMatchingAlgorithm ccMatchScalesDlg::getSelectedAlgorithm()
        const {
