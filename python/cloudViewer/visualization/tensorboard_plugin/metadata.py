...
def parse_plugin_metadata(content):
    ...
    Arguments:
      content: The `content` field of a `SummaryMetadata` proto
        corresponding to the CloudViewer plugin.
    """
    ln_proto = LabelToNames()
