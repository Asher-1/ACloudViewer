...
_LABELTONAMES_LABELTONAMESENTRY = _LABELTONAMES.nested_types_by_name[
    'LabelToNamesEntry']
_CLOUDVIEWERPLUGINDATA_GEOMETRYPROPERTY = _CLOUDVIEWERPLUGINDATA.enum_types_by_name[
    'GeometryProperty']
CloudViewerPluginData = _reflection.GeneratedProtocolMessageType(
    'CloudViewerPluginData',
    (_message.Message,),
    {
        'PropertyReference':
            _reflection.GeneratedProtocolMessageType(
                ...
                (_message.Message,),
                {
                    'DESCRIPTOR': _CLOUDVIEWERPLUGINDATA_PROPERTYREFERENCE,
                    '__module__': 'plugin_data_pb2'
                    # @@protoc_insertion_point(class_scope:tensorboard.cloudViewer.CloudViewerPluginData.PropertyReference)
                }),
        'StartSize':
            _reflection.GeneratedProtocolMessageType(
                'StartSize',
                (_message.Message,),
                {
                    'DESCRIPTOR': _CLOUDVIEWERPLUGINDATA_STARTSIZE,
                    '__module__': 'plugin_data_pb2'
                    # @@protoc_insertion_point(class_scope:tensorboard.cloudViewer.CloudViewerPluginData.StartSize)
                }),
        'BatchIndex':
            _reflection.GeneratedProtocolMessageType(
                'BatchIndex',
                (_message.Message,),
                {
                    'DESCRIPTOR': _CLOUDVIEWERPLUGINDATA_BATCHINDEX,
                    '__module__': 'plugin_data_pb2'
                    # @@protoc_insertion_point(class_scope:tensorboard.cloudViewer.CloudViewerPluginData.BatchIndex)
                }),
        'DESCRIPTOR':
            _CLOUDVIEWERPLUGINDATA,
        '__module__':
            'plugin_data_pb2'
        # @@protoc_insertion_point(class_scope:tensorboard.cloudViewer.CloudViewerPluginData)
    })
_sym_db.RegisterMessage(CloudViewerPluginData)
_sym_db.RegisterMessage(CloudViewerPluginData.PropertyReference)
_sym_db.RegisterMessage(CloudViewerPluginData.StartSize)
_sym_db.RegisterMessage(CloudViewerPluginData.BatchIndex)
        ...
        'InferenceResult':
            _reflection.GeneratedProtocolMessageType(
                ...
                (_message.Message,),
                {
                    ...
                    '__module__': 'plugin_data_pb2'
                    # @@protoc_insertion_point(class_scope:tensorboard.cloudViewer.InferenceData.InferenceResult)
                }),
        'DESCRIPTOR':
            _INFERENCEDATA,
        '__module__':
            'plugin_data_pb2'
        # @@protoc_insertion_point(class_scope:tensorboard.cloudViewer.InferenceData)
    })
        ...
        'LabelToNamesEntry':
            _reflection.GeneratedProtocolMessageType(
                ...
                (_message.Message,),
                {
                    ...
                    '__module__': 'plugin_data_pb2'
                    # @@protoc_insertion_point(class_scope:tensorboard.cloudViewer.LabelToNames.LabelToNamesEntry)
                }),
        'DESCRIPTOR':
            _LABELTONAMES,
        '__module__':
            'plugin_data_pb2'
        # @@protoc_insertion_point(class_scope:tensorboard.cloudViewer.LabelToNames)
    })
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _CLOUDVIEWERPLUGINDATA._serialized_start = 42
    _CLOUDVIEWERPLUGINDATA._serialized_end = 1756
    _CLOUDVIEWERPLUGINDATA_PROPERTYREFERENCE._serialized_start = 234
    _CLOUDVIEWERPLUGINDATA_PROPERTYREFERENCE._serialized_end = 353
    _CLOUDVIEWERPLUGINDATA_STARTSIZE._serialized_start = 355
    _CLOUDVIEWERPLUGINDATA_STARTSIZE._serialized_end = 482
    _CLOUDVIEWERPLUGINDATA_BATCHINDEX._serialized_start = 484
    _CLOUDVIEWERPLUGINDATA_BATCHINDEX._serialized_end = 582
    _CLOUDVIEWERPLUGINDATA_GEOMETRYPROPERTY._serialized_start = 585
    _CLOUDVIEWERPLUGINDATA_GEOMETRYPROPERTY._serialized_end = 1756
