...
def test_apply_depth_noise_model():
    ...
    class Simulator:
        ...
        def simulate(self,
            ...
            a = cv3d.t.io.read_image(inputpng).as_tensor()
            ...
            cv3d.t.io.write_image(outputpng, cv3d.t.geometry.Image(a))
    ...
    im_src_uint16 = cv3d.t.io.read_image(im_src_path).as_tensor().numpy()
    ...
    with tempfile.TemporaryDirectory() as dst_dir:
        ...
        im_dst_gt = cv3d.t.io.read_image(im_dst_path).as_tensor().numpy()
    ...
    # With uint16 input.
    im_src = cv3d.t.geometry.Image(im_src_uint16)
    ...
    # With float32 input.
    im_src = cv3d.t.geometry.Image(im_src_float32)
