...
.. code-block:: python
    ...
    material.albedo_img = cv3d.io.read_image('/Users/renes/Downloads/uv1.png')
...
.. code-block:: python
    ...
    cv3d.visualization.draw({'name': 'box', 'geometry': box, 'material': material})
...
.. code-block:: python
    ...
    box = cv3d.geometry.TriangleMesh.create_box(create_uv_map=True, map_texture_to_each_face=True)
    cv3d.visualization.draw({'name': 'box', 'geometry': box, 'material': material})
...
.. code-block:: python
    ...
    tetra = cv3d.geometry.TriangleMesh.create_tetrahedron(create_uv_map=True)
    cv3d.visualization.draw({'name': 'tetrahedron', 'geometry': tetra, 'material': material})
...
.. code-block:: python
    ...
    octo = cv3d.geometry.TriangleMesh.create_octahedron(create_uv_map=True)
    cv3d.visualization.draw({'name': 'octahedron', 'geometry': octo, 'material': material})
...
.. code-block:: python
    ...
    ico = cv3d.geometry.TriangleMesh.create_icosahedron(create_uv_map=True)
    cv3d.visualization.draw({'name': 'icosahedron', 'geometry': ico, 'material': material})
...
.. code-block:: python
    ...
    cylinder = cv3d.geometry.TriangleMesh.create_cylinder(create_uv_map=True)
    cv3d.visualization.draw({'name': 'cylinder', 'geometry': cylinder, 'material': material})
...
.. code-block:: python
    ...
    cone = cv3d.geometry.TriangleMesh.create_cone(create_uv_map=True)
    cv3d.visualization.draw({'name': 'cone', 'geometry': cone, 'material': material})
...
.. code-block:: python
    ...
    sphere = cv3d.geometry.TriangleMesh.create_sphere(create_uv_map=True)
    cv3d.visualization.draw({'name': 'sphere', 'geometry': sphere, 'material': material})
