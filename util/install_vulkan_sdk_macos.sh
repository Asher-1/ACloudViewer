...
VULKAN_SDK="$(resolve_vulkan_sdk_from_setup_script "${setup_script}")"
...
if [[ ! -x "${glslc_path}" || ! -f "${spirv_header}" || -z "${moltenvk_icd}" ]]; then
...
{
    printf '# Generated by util/install_vulkan_sdk_macos.sh — do not edit by hand.\n'
