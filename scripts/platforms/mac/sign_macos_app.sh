...
echo $#
if [[ $# != 6 ]]; then
    echo "Usage: $0 path/to/ACloudViewer.app path/to/ACloudViewer.entitlements apple-id cert_id team-id password"
    exit 1
fi
...
codesign --deep --force --timestamp --entitlements $2 --sign $4 $1
