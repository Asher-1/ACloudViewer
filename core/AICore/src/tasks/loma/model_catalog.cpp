...
constexpr aicore_loma_model_entry kModels[] = {
        {"loma_detector.f32.gguf",
         ...
         AICORE_LOMA_MODEL_ROLE_DETECTOR, AICORE_LOMA_MODEL_VARIANT_DAD},
        {"loma_descriptor_dedode_b.f32.gguf",
         "https://github.com/Asher-1/cloudViewer_downloads/releases/download/"
         "LoMa_GUFF/"
         "loma_descriptor_dedode_b.f32.gguf",
         "LoMa DeDoDe-B descriptor (F32, B128 compatible)",
         AICORE_LOMA_MODEL_ROLE_DESCRIPTOR, AICORE_LOMA_MODEL_VARIANT_DEDODE_B},
        {"loma_descriptor_dedode_g.f32.gguf",
         "https://github.com/Asher-1/cloudViewer_downloads/releases/download/"
         "LoMa_GUFF/"
         "loma_descriptor_dedode_g.f32.gguf",
         "LoMa DeDoDe-G descriptor (F32, recommended)",
         AICORE_LOMA_MODEL_ROLE_DESCRIPTOR, AICORE_LOMA_MODEL_VARIANT_DEDODE_G},
        {"loma_matcher_B.f32.gguf",
         "https://github.com/Asher-1/cloudViewer_downloads/releases/download/"
         "LoMa_GUFF/"
         "loma_matcher_B.f32.gguf",
         "LoMa-B matcher (F32, recommended)", AICORE_LOMA_MODEL_ROLE_MATCHER,
        ...
        {"loma_matcher_R.f32.gguf",
         ...
         "LoMa_GUFF/"
         "loma_matcher_R.f32.gguf",
         "LoMa-R matcher (F32)", AICORE_LOMA_MODEL_ROLE_MATCHER,
         AICORE_LOMA_MODEL_VARIANT_MATCHER_R},
        {"loma_matcher_L.f32.gguf",
         "https://github.com/Asher-1/cloudViewer_downloads/releases/download/"
         "LoMa_GUFF/"
         "loma_matcher_L.f32.gguf",
         "LoMa-L matcher (F32)", AICORE_LOMA_MODEL_ROLE_MATCHER,
         AICORE_LOMA_MODEL_VARIANT_MATCHER_L},
        {"loma_matcher_G.f32.gguf",
         "https://github.com/Asher-1/cloudViewer_downloads/releases/download/"
         "LoMa_GUFF/"
         "loma_matcher_G.f32.gguf",
         "LoMa-G matcher (F32)", AICORE_LOMA_MODEL_ROLE_MATCHER,
         AICORE_LOMA_MODEL_VARIANT_MATCHER_G},
        {"loma_detector.f16.gguf",
         "https://github.com/Asher-1/cloudViewer_downloads/releases/download/"
         "LoMa_GUFF/"
         "loma_detector.f16.gguf",
         "LoMa DaD detector (F16)", AICORE_LOMA_MODEL_ROLE_DETECTOR,
        ...
        {"loma_descriptor_dedode_g.f16.gguf",
         ...
         "LoMa_GUFF/"
         "loma_descriptor_dedode_g.f16.gguf",
         "LoMa DeDoDe-G descriptor (F16)", AICORE_LOMA_MODEL_ROLE_DESCRIPTOR,
         AICORE_LOMA_MODEL_VARIANT_DEDODE_G},
        {"loma_descriptor_dedode_g.q8_0.gguf",
         "https://github.com/Asher-1/cloudViewer_downloads/releases/download/"
         "LoMa_GUFF/"
         "loma_descriptor_dedode_g.q8_0.gguf",
         "LoMa DeDoDe-G descriptor (Q8_0)", AICORE_LOMA_MODEL_ROLE_DESCRIPTOR,
         AICORE_LOMA_MODEL_VARIANT_DEDODE_G},
        {"loma_matcher_B.f16.gguf",
         "https://github.com/Asher-1/cloudViewer_downloads/releases/download/"
         "LoMa_GUFF/"
         "loma_matcher_B.f16.gguf",
         "LoMa-B matcher (F16)", AICORE_LOMA_MODEL_ROLE_MATCHER,
         AICORE_LOMA_MODEL_VARIANT_MATCHER_B},
        {"loma_matcher_B.q8_0.gguf",
         "https://github.com/Asher-1/cloudViewer_downloads/releases/download/"
         "LoMa_GUFF/"
         "loma_matcher_B.q8_0.gguf",
         "LoMa-B matcher (Q8_0)", AICORE_LOMA_MODEL_ROLE_MATCHER,
         AICORE_LOMA_MODEL_VARIANT_MATCHER_B},
        ...
        {"loma_matcher_R.f16.gguf",
         ...
         "LoMa_GUFF/"
         "loma_matcher_R.f16.gguf",
         "LoMa-R matcher (F16)", AICORE_LOMA_MODEL_ROLE_MATCHER,
         AICORE_LOMA_MODEL_VARIANT_MATCHER_R},
        {"loma_matcher_R.q8_0.gguf",
         "https://github.com/Asher-1/cloudViewer_downloads/releases/download/"
         "LoMa_GUFF/"
         "loma_matcher_R.q8_0.gguf",
         "LoMa-R matcher (Q8_0)", AICORE_LOMA_MODEL_ROLE_MATCHER,
         AICORE_LOMA_MODEL_VARIANT_MATCHER_R},
        {"loma_matcher_L.f16.gguf",
         "https://github.com/Asher-1/cloudViewer_downloads/releases/download/"
         "LoMa_GUFF/"
         "loma_matcher_L.f16.gguf",
         "LoMa-L matcher (F16)", AICORE_LOMA_MODEL_ROLE_MATCHER,
         AICORE_LOMA_MODEL_VARIANT_MATCHER_L},
        {"loma_matcher_L.q8_0.gguf",
         "https://github.com/Asher-1/cloudViewer_downloads/releases/download/"
         "LoMa_GUFF/"
         "loma_matcher_L.q8_0.gguf",
         "LoMa-L matcher (Q8_0)", AICORE_LOMA_MODEL_ROLE_MATCHER,
         AICORE_LOMA_MODEL_VARIANT_MATCHER_L},
        {"loma_matcher_G.f16.gguf",
         "https://github.com/Asher-1/cloudViewer_downloads/releases/download/"
         "LoMa_GUFF/"
         "loma_matcher_G.f16.gguf",
         "LoMa-G matcher (F16)", AICORE_LOMA_MODEL_ROLE_MATCHER,
         AICORE_LOMA_MODEL_VARIANT_MATCHER_G},
        {"loma_matcher_G.q8_0.gguf",
         "https://github.com/Asher-1/cloudViewer_downloads/releases/download/"
         "LoMa_GUFF/"
         "loma_matcher_G.q8_0.gguf",
         "LoMa-G matcher (Q8_0)", AICORE_LOMA_MODEL_ROLE_MATCHER,
         AICORE_LOMA_MODEL_VARIANT_MATCHER_G},
};
