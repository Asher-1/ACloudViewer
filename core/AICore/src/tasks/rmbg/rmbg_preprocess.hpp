...
/* Direct stride-aware preprocessing for borrowed RGB/RGBA/gray/BGR/BGRA
 * images. The only full-resolution allocation is the RGBA output buffer that
 * is required for compositing the inferred matte. */
