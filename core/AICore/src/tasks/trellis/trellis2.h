...
TRELLIS2_API trellis2_rmbg_model *
trellis2_rmbg_load(const char * gguf_path, const char * device = "auto",
                   std::string * error = nullptr);

TRELLIS2_API void
trellis2_rmbg_free(trellis2_rmbg_model * m);
...
TRELLIS2_API int
trellis2_rmbg_remove_background(trellis2_rmbg_model * m,
                                const uint8_t * rgba, int w, int h,
                                uint8_t ** out_rgba, int * out_len,
                                std::string * error = nullptr);

TRELLIS2_API void
trellis2_rmbg_free_buffer(uint8_t * buf);

TRELLIS2_API bool
trellis2_rmbg_available();
