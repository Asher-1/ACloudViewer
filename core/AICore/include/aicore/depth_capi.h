...
AICORE_CAPI aicore_depth_ctx* aicore_depth_load_device(
        ...
        int n_threads,
        const char* device); /* auto|cpu|cuda|opencl|vulkan|metal */
...
AICORE_CAPI float* aicore_depth_depth_path(aicore_depth_ctx* ctx,
                                           ...
                                           int* out_h,
                                           int* out_w);
AICORE_CAPI void aicore_depth_free_floats(float* p);
...
AICORE_CAPI void aicore_depth_free_bytes(unsigned char* p);
