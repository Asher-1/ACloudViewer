								...
								char* outputErrorStr/*=0*/)
{
	...
	typedef CGAL::No_constraint_intersection_requiring_constructions_tag  Itag; //This tag could ben changed if we decide to handle intersection
...
void Delaunay2dMesh::getTriangleVertices(unsigned triangleIndex, double A[3], double B[3], double C[3]) const
{
	assert(m_associatedCloud && triangleIndex < m_numberOfTriangles);
