...
public:
    ...
    **/
    ...
    /** The cube dimensions will be equal to the largest box dimension.
            ...
            \param enlargeFactor the resulting box can be automatically enlarged
    ...
    **/
    ...
    /** Determines at least two orthogonal vectors perpendicular to a third one
            ...
            \param[out] X the first vector (a 3 coordinates array to be updated
    by the algorithm) \param[out] Y the second vector (a 3 coordinates array to
    be updated by the algorithm)
    **/
