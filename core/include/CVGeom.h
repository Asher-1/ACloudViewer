...
#ifndef CV_GEOM_HEADER
#define CV_GEOM_HEADER
...
public:
	...
	**/
	...
	static inline Tuple4Tpl fromArray(const Eigen::Matrix<Type, 4, 1>& a) { return Tuple4Tpl(static_cast<Type>(a[0]), static_cast<Type>(a[1]), static_cast<Type>(a[2]), static_cast<Type>(a[3])); }
	static inline Eigen::Matrix<Type, 4, 1> fromArray(const Tuple4Tpl<float> &a) { return Eigen::Matrix<Type, 4, 1>(static_cast<Type>(a[0]), static_cast<Type>(a[1]), static_cast<Type>(a[2]), static_cast<Type>(a[3])); }
	static inline Eigen::Matrix<Type, 4, 1> fromArray(const Tuple4Tpl<double> &a) { return Eigen::Matrix<Type, 4, 1>(static_cast<Type>(a[0]), static_cast<Type>(a[1]), static_cast<Type>(a[2]), static_cast<Type>(a[3])); }

	//! Copy Function
	inline Tuple4Tpl(const Eigen::Matrix<float, 4, 1>& v)
	{
		*this = v;
	}
	inline Tuple4Tpl(const Eigen::Matrix<double, 4, 1>& v)
	{
		*this = v;
	}
	//! Assignment Function
...
public:
	...
	**/
	...
	//! Constructor from a Eigen vector
	static inline Vector3Tpl fromArray(const Eigen::Matrix<double, 3, 1>& a) { return Vector3Tpl(static_cast<Type>(a[0]), static_cast<Type>(a[1]), static_cast<Type>(a[2])); }
	static inline Eigen::Matrix<Type, 3, 1> fromArray(const Vector3Tpl<float> &a) { return Eigen::Matrix<Type, 3, 1>(static_cast<Type>(a[0]), static_cast<Type>(a[1]), static_cast<Type>(a[2])); }
	static inline Eigen::Matrix<Type, 3, 1> fromArray(const Vector3Tpl<double> &a) { return Eigen::Matrix<Type, 3, 1>(static_cast<Type>(a[0]), static_cast<Type>(a[1]), static_cast<Type>(a[2])); }
	
	static inline std::vector< Eigen::Matrix<double, 3, 1> > fromArrayContainer(const std::vector< Vector3Tpl<Type> >& container)
	{
	...
	static inline std::vector<Vector3Tpl> fromArrayContainer(const std::vector< Eigen::Matrix<double, 3, 1> >& container)
	{
		...
		{
			points[i] = Vector3Tpl(
				static_cast<Type>(container[i](0)),
	...
	//! Copy Function
	inline Vector3Tpl(const Eigen::Matrix<float, 3, 1>& v)
	{
		*this = v;
	}
	inline Vector3Tpl(const Eigen::Matrix<double, 3, 1>& v)
	{
		*this = v;
	}
	...
	inline Vector3Tpl operator - (const Eigen::Matrix<double, 3, 1>& v) const { 
		return Vector3Tpl(static_cast<Type>(x - v(0)), static_cast<Type>(y - v(1)), static_cast<Type>(z - v(2))); 
	}	
	...
	inline Vector3Tpl operator * (const Eigen::Matrix<double, 3, 1>& v) const { return cross(v); }
	
	//! Dot product operator
	inline Type operator && (const Eigen::Matrix<double, 3, 1>& v) const { return dot(v); }


	inline friend std::ostream &operator<<(std::ostream &stream, const Vector3Tpl &v)
	{
		stream << "[x->" << v.x << ", y->" << v.y << ", z->" << v.x << "]" << std::endl;
		return stream;
	}
	...
	//! x,y,z maximum
	inline Type maxCoeff() const { return x > y ? (x > z ? x : z) : (y > z ? y : z); }
	//! x,y,z product
