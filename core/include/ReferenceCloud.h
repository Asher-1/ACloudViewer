...
/** Implements the GenericIndexedCloudPersist interface. A simple point cloud
        ...
        Partial thread safety for all methods that can change the size of the
cloud or that change or rely on point ordering.
**/
...
public:
    ...
    //! Returns global index (i.e. relative to the associated cloud) of a given
    //! element
