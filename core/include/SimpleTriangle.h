...
**/
class CV_CORE_LIB_API SimpleRefTriangle : public GenericTriangle {
public:
    //! Default constructor
    SimpleRefTriangle() : A(nullptr), B(nullptr), C(nullptr) {}
    ...
    **/
    SimpleRefTriangle(const CCVector3* _A,
                      const CCVector3* _B,
                      const CCVector3* _C)
        : A(_A), B(_B), C(_C) {}
...
**/
class CV_CORE_LIB_API SimpleTriangle : public GenericTriangle {
public:
    //! Default constructor
    ...
    /** \param _A first vertex
            ...
            \param _C third vertex
    **/
    SimpleTriangle(const CCVector3& _A,
                   const CCVector3& _B,
                   const CCVector3& _C)
        : A(_A), B(_B), C(_C) {}
