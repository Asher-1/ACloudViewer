...
bool GsHead::raw_gaussians(const std::vector<std::vector<float>>& feats,
    ...
    bool ok = be_.compute([&](ggml_context* ctx) -> ggml_tensor* {
        ...
        // Compute refinenet target sizes dynamically from actual patch grid.
        // resize_layers produce: l[0]=4pw x 4ph, l[1]=2pw x 2ph, l[2]=pw x ph,
        // l[3]=(pw+1)/2 x (ph+1)/2. RefineNet fuses bottom-up:
        ...
        // refinenet4 (no residual / no rc1): top=l4_rn, upsample to l[2] size
        ggml_tensor* out = feature_fusion(ctx, l4_rn, nullptr,
            ...
            t("gs.scratch.rn4.out.weight"), t("gs.scratch.rn4.out.bias"), rn4_w, rn4_h);
        ...
        out = feature_fusion(ctx, out, l3_rn,
            ...
            t("gs.scratch.rn3.out.weight"), t("gs.scratch.rn3.out.bias"), rn3_w, rn3_h);
        ...
        out = feature_fusion(ctx, out, l2_rn,
            ...
            t("gs.scratch.rn2.out.weight"), t("gs.scratch.rn2.out.bias"), rn2_w, rn2_h);
