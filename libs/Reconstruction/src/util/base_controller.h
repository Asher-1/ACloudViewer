...
// ----------------------------------------------------------------------------
//
// Upstream COLMAP dbb41680 (util/base_controller.h) port. Fork adaptation:
// include paths only.
...
protected:
    ...
    // set/reset and called from within the controller. Hence, this method
    // should be called from the derived controller constructor.
