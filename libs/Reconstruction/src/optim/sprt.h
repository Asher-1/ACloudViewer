...
public:
    struct Options {
        ...
        // The ratio of the time it takes to estimate a model from a random
        // sample over the time it takes to decide whether one data sample is an
        // inlier or not. Matas et al. propose 200 for the 7-point algorithm.
        double eval_time_ratio = 200;

        // Number of models per random sample, that have to be verified. E.g.
        // 1-3 for the 7-point fundamental matrix algorithm, or 1-10 for the
