...
// counted once in num_unique_inliers. The support is better if it has more
// unique inliers, more inliers, and a smaller residual sum.
struct UniqueInlierSupportMeasurer {
    struct Support {
        // The number of unique inliers.
        size_t num_unique_inliers = 0;

        // The number of inliers. This is still needed for determining the
