...
struct GlobalPositionerOptions {
    ...
    // Whether to initialize the camera scales to a constant 1 or derive them
    // from the initialized camera and point positions.
...
protected:
    ...
    // Temporary storage for camera-in-rig positions when cam_from_rig is
