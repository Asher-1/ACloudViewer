...
// ----------------------------------------------------------------------------
//
// Upstream COLMAP dbb41680 (scene/correspondence_graph_test.cc) port. Fork
// adaptations: include paths and the Database::ImagePairToPairId static
// method instead of the upstream free function.
