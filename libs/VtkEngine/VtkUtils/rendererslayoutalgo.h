...
/// @file rendererslayoutalgo.h
/// @brief Layout algorithms for VTK renderers in multi-viewport grids.
...
/// @brief Layout N renderers in a grid; specialized for count 1-10.
/// @param renderers List of renderers (size must match count)
template <int count>
