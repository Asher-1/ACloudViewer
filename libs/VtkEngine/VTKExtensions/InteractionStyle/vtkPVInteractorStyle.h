...
/**
 * @file vtkPVInteractorStyle.h
 * @brief ParaView-style trackball camera interactor with manipulator
 * collection.
 */
 ...
 * @brief ParaView-style trackball camera interactor with configurable
 * manipulators.
 */
class QVTK_ENGINE_LIB_API vtkPVInteractorStyle
