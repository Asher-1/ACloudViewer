...
/**
 * @file vtkPVJoystickFly.h
 * @brief Base joystick-style fly camera manipulator.
 */
 ...
 * @brief Joystick-style fly-through camera manipulator.
 */
class QVTK_ENGINE_LIB_API vtkPVJoystickFly : public vtkCameraManipulator {
public:
