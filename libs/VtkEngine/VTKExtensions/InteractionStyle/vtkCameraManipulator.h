...
/**
 * @file vtkCameraManipulator.h
 * @brief Base class for camera manipulators (rotate, pan, zoom, etc.).
 */
 ...
 * @brief Base class for camera manipulation (rotate, pan, zoom, fly, etc.).
 */
class QVTK_ENGINE_LIB_API vtkCameraManipulator : public vtkObject {
public:
