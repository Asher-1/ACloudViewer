...
/**
 * @file vtkBoundedPlaneSource.h
 * @brief Generates a plane poly data clipped to a bounding box
 */
 ...
 * @brief Plane source with center, normal, and bounding box clipping
 */
class QVTK_ENGINE_LIB_API vtkBoundedPlaneSource : public vtkPolyDataAlgorithm {
public:
    ...
    //@{
    /**
     * Specify the resolution of the plane. Used only when RefinementMode is set
     * to USE_RESOLUTION.
     */
    ...
    //@{
    /**
     * Specify the cell-size of the plane. Used only when RefinementMode is set
     * to USE_CELL_SIZE.
     */
