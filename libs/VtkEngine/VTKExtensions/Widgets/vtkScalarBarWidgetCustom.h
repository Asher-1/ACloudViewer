...
/**
 * @file vtkScalarBarWidgetCustom.h
 * @brief Scalar bar widget with custom representation and actor creation.
 */
 ...
 * @brief Scalar bar widget with custom default representation and actor.
 */
class QVTK_ENGINE_LIB_API vtkScalarBarWidgetCustom : public vtkScalarBarWidget {
public:
     ...
     * @param rep Scalar bar representation
     */
     ...
     */
    /// @param actor Scalar bar actor to use
