...
class QVTK_ENGINE_LIB_API vtkGridAxesActor3D : public vtkProp3D {
public:
     ...
     * If nothing is set, then the default is to use whatever was generated by
     * vtkAxis.
     *
    ...
    VTK_WRAPEXCLUDE virtual void GetLabelDisplayOffset(int& xoffset,
                                                       int& yoffset);
