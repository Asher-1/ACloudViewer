...
class QVTK_ENGINE_LIB_API vtkPVAxesWidget : public vtkInteractorObserver {
public:
    ...
    ///@{
    /**
     * Get/Set the visibility. Note if visibility is off, Enabled state is
     * ignored and assumed off.
     */
