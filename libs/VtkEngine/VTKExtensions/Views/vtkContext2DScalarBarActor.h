...
/**
 * @file vtkContext2DScalarBarActor.h
 * @brief Scalar bar actor using vtkContext2D for rendering.
 */
 ...
 * @brief Scalar bar actor rendered via vtkContext2D with extended layout
 * options.
 */
class QVTK_ENGINE_LIB_API vtkContext2DScalarBarActor
...
public:
     ...
     * automatically generated to make the numbers best fit within the widget.
    ...
    //@{
    /**
     * Set whether annotations are automatically created according the number
     ...
     * Use custom labels.
     */
    /// @param useLabels Whether to use custom labels
     ...
     */
    /// @param numLabels Number of custom labels
    void SetNumberOfCustomLabels(vtkIdType numLabels);
    /// @return Number of custom labels
    ...
    /// @param value Scalar value for the label
     ...
     */
    /// @param painter Context 2D painter
     ...
     * coordinates.
     */
    /// @return Bounding rectangle in display coordinates
     ...
     */
    /// @return Estimated number of annotations
...
private:
     ...
     * indexed color maps.
     */
    void PaintAnnotations(vtkContext2D* painter,
                          double size[2],
     ...
     */
    void PaintAnnotationsVertically(vtkContext2D* painter,
                                    double size[2],
                                    const vtkAnnotationMap& map);
     ...
     */
    void PaintAnnotationsHorizontally(vtkContext2D* painter,
                                      double size[2],
                                      const vtkAnnotationMap& map);
};
