...
/**
 * @file vtkPVXMLElement.h
 * @brief DOM-like XML element for ParaView-style configuration
 */
 ...
 * @brief Tree node for XML parsing with attribute and nested element access
 */
class QVTK_ENGINE_LIB_API vtkPVXMLElement : public vtkObject {
public:
     ...
     */
    void ReplaceNestedElement(vtkPVXMLElement* elementToReplace,
    ...
    void GetElementsByName(const char* name,
    ...
    /**
     * Copy the attributes from current XML element content into the provided
     * one.
     */
