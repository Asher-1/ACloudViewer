...
/**
 * @file vtkCommandOptionsXMLParser.h
 * @brief XML parser for command-line option definitions
 */
 ...
 * @brief Parses XML to populate vtkCommandOptions arguments
 */
class QVTK_ENGINE_LIB_API vtkCommandOptionsXMLParser : public vtkXMLParser {
public:
     ...
     * @param longarg Long option name (e.g. "--foo")
     * @param var Variable to set
     * @param type Process type mask (default 0 = all)
     */
    ...
    /// @param o vtkCommandOptions instance to populate
