...
/**
 * @file vtkPVPostFilter.h
 * @brief Filter for array conversions (cell/point, component extraction)
 */
...
class QVTK_ENGINE_LIB_API vtkPVPostFilter : public vtkDataObjectAlgorithm {
public:
