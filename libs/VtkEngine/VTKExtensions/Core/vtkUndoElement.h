...
/**
 * @file vtkUndoElement.h
 * @brief Abstract base class for undo/redo operations
 */
 ...
 * @brief Abstract base for a single undoable/redoable operation
 */
class QVTK_ENGINE_LIB_API vtkUndoElement : public vtkObject {
public:
     ...
     * @param new_element The newly added element to merge with
    ...
    /**
     * @param workCTX Collection to hold references during undo/redo
     */
