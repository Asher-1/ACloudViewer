...
/**
 * @file vtkPVTrivialProducer.h
 * @brief Trivial producer with time step support for pipeline output
 */
 ...
 * @brief Produces data without modification, supports time information
 */
class QVTK_ENGINE_LIB_API vtkPVTrivialProducer : public vtkTrivialProducer {
public:
     ...
     * @param output Data object to produce
     * @param time Time value for this output
     */
