...
/**
 * @file vtkMemberFunctionCommand.h
 * @brief VTK command that invokes a class member function on event
 */
 ...
 * @brief VTK command adapter for class member function callbacks
 * @tparam ClassT Class type whose member is invoked
 */
...
public:
     ...
     * event is received.
     * @param object Instance to call
     * @param method Member function (no parameters)
     */
    ...
    /**
     * Set callback with full VTK event signature.
     * @param object Instance to call
     * @param method2 Member function (caller, eventId, calldata)
     */
