...
/**
 * @file vtkCommunicationErrorCatcher.h
 * @brief RAII helper to capture MPI/communication errors
 */
 ...
 * @brief Observes controller/communicator and captures error events
 */
class QVTK_ENGINE_LIB_API vtkCommunicationErrorCatcher {
public:
    /** @param controller Controller to observe for error events */
    vtkCommunicationErrorCatcher(vtkMultiProcessController* controller);
    /** @param communicator Communicator to observe for error events */
    vtkCommunicationErrorCatcher(vtkCommunicator* communicator);
