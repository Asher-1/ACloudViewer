...
/**
 * @file vtkBoundingRectContextDevice2D.h
 * @brief Context device 2D that tracks bounding rect of drawn primitives.
 */
...
class QVTK_ENGINE_LIB_API vtkBoundingRectContextDevice2D
