...
/**
 * @file cvConstrainedLineRepresentation.h
 * @brief Extended line representation with distance display and ruler features
 */
...
public:
     ...
     * @param handle Prototype handle to copy attributes from
     */
