...
/**
 * @file cvCustomAxisHandleRepresentation.h
 * @brief Handle representation with custom translation axis (VTK 9.3+ backport)
 */
...
/**
 * @class cvCustomAxisHandleRepresentation
...
public:
    ...
    /**
     * @brief Set the custom translation axis by components
