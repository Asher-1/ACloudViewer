...
/**
 * @file vtkCallbackTools.h
 * @brief Callback classes for VTK interactive widgets (implicit plane, box,
 * angle).
 */
...
class QVTK_ENGINE_LIB_API vtkIPWCallback
...
// box callback class
class QVTK_ENGINE_LIB_API vtkBoxCallback
    : public VtkUtils::AbstractWidgetObserver {
    Q_OBJECT
public:
...
// box callback2 class
class QVTK_ENGINE_LIB_API vtkBoxCallback2
    : public VtkUtils::AbstractWidgetObserver {
public:
...
class QVTK_ENGINE_LIB_API vtkAngleCallBack
    : public VtkUtils::AbstractWidgetObserver {
public:
