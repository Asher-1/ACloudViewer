 ...
 * @brief Merges connected cells by region ID across blocks (parallel)
 */
class QVTK_ENGINE_LIB_API vtkPMergeConnected
...
public:
    ...
    /// Internal structure for face hashing during merge
    struct FaceWithKey {
        int num_pts;
        vtkIdType *key, *orig;
    };
