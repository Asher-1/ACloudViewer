...
/**
 * @file vtkMinkowskiFilter.h
 * @brief Computes Minkowski functionals (S, V, C, X, G, T, B, L, P, F) for
 * polyhedra
 */

#include "qVTK.h"  // For export macro
 ...
 * @brief Computes Minkowski functionals for each cell in unstructured grid
 */
class QVTK_ENGINE_LIB_API vtkMinkowskiFilter
