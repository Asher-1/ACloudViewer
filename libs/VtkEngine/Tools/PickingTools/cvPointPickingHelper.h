...
/**
 * @file cvPointPickingHelper.h
 * @brief Helper class for keyboard shortcut-based point picking in measurement
 * tools (inspired by ParaView's pqPointPickingHelper).
 */
...
public:
     ...
     * @param renderer Renderer for picking operations
     */
    void setRenderer(vtkRenderer* renderer);

    /**
     * @brief Set the context widget for the shortcut
     * @param widget Widget that receives the shortcut
     */
