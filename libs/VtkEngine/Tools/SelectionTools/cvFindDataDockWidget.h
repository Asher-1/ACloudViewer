...
/**
 * @file cvFindDataDockWidget.h
 * @brief Dock widget for Find Data / Selection Properties panel (ParaView
 * style).
 */
 ...
 *
 * Provides a standalone dock panel for selection properties,
 ...
 */
class QVTK_ENGINE_LIB_API cvFindDataDockWidget : public QDockWidget {
    Q_OBJECT
