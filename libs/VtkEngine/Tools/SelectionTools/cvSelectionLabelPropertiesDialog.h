...
/**
 * @file cvSelectionLabelPropertiesDialog.h
 * @brief Dialog for editing selection label properties (ParaView style).
 */
...
/**
 * @class cvSelectionLabelPropertiesDialog
 ...
 * - Point Label Format
 */
class QVTK_ENGINE_LIB_API cvSelectionLabelPropertiesDialog : public QDialog {
    Q_OBJECT
...
public:
     ...
     * @param isInteractive If true, edit interactive (hover) label properties
     */
     ...
     * @return Current label properties
     */
