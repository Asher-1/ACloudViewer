...
/**
 * @file cvSelectionData.h
 * @brief Selection data types, enums, and cvSelectionData class
 * (VTK-independent selection encapsulation).
 */
 ...
 * selection sources.
 */
struct QVTK_ENGINE_LIB_API cvActorSelectionInfo {
 ...
 * data.
 */
class QVTK_ENGINE_LIB_API cvSelectionData {
public:
    /**
