...
/**
 * @file cvViewSelectionManager.h
 * @brief Central manager for all selection operations in the view (ParaView
 * pqRenderViewSelectionReaction style).
 */
 ...
 */
class QVTK_ENGINE_LIB_API cvViewSelectionManager
    : public QObject,
