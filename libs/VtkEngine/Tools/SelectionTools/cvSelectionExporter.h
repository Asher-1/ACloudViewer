...
/**
 * @file cvSelectionExporter.h
 * @brief Helper for exporting selections to CloudViewer objects or files.
 */
 ...
 */
class QVTK_ENGINE_LIB_API cvSelectionExporter {
public:
    /**
