...
/**
 * @file cvSelectionToolController.h
 * @brief Controller for selection tools and UI (ParaView
 * pqStandardViewFrameActionsImplementation style).
 */
 ...
 */
class QVTK_ENGINE_LIB_API cvSelectionToolController : public QObject {
    Q_OBJECT
...
public:
     ...
     * @param viewer 3D visualizer instance
     */
