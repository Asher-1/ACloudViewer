...
/**
 * @file cvExpanderButton.h
 * @brief Collapsible section toggle button (ParaView pqExpanderButton style).
 */
 ...
 * @brief Frame with toggle mode for collapsible sections.
 *
 * Based on ParaView's pqExpanderButton. Used to simulate
 ...
 */
class QVTK_ENGINE_LIB_API cvExpanderButton : public QFrame {
    Q_OBJECT
