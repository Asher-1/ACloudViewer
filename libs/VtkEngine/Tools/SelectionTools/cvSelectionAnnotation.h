...
/**
 * @file cvSelectionAnnotation.h
 * @brief Selection annotation manager and cvAnnotation struct (ParaView style).
 */
 ...
 */
struct QVTK_ENGINE_LIB_API cvAnnotation {
 ...
 */
class QVTK_ENGINE_LIB_API cvSelectionAnnotationManager : public QObject {
    Q_OBJECT
...
public:
     ...
     */
    void setVisualizer(Visualization::VtkVis* viewer);
