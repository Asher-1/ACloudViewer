...
/**
 * @file cvSelectionAlgebra.h
 * @brief Selection algebra operations and cvSelectionFilter (ParaView style).
 */
...
// clang-format off
// Qt - must be included before qVTK.h and cvSelectionData.h for MOC to work correctly
...
// LOCAL
// Note: cvSelectionData.h includes qVTK.h, so we include it after Qt headers
 ...
 */
class QVTK_ENGINE_LIB_API cvSelectionAlgebra : public QObject {
    Q_OBJECT
 ...
 */
class QVTK_ENGINE_LIB_API cvSelectionFilter : public QObject {
    Q_OBJECT
