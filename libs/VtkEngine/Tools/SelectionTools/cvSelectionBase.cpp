...
//-----------------------------------------------------------------------------
Visualization::VtkVis* cvSelectionBase::getVtkVis() const {
    if (!m_viewer) {
        return nullptr;
    }
    return reinterpret_cast<Visualization::VtkVis*>(m_viewer);
}

//-----------------------------------------------------------------------------
bool cvSelectionBase::hasValidVtkVis() const {
    return m_viewer && getVtkVis() != nullptr;
}
