...
/**
 * @file cvSelectionBase.h
 * @brief Lightweight base class for selection-related components (visualizer
 * access only).
 */
 ...
 */
class QVTK_ENGINE_LIB_API cvSelectionBase {
public:
     ...
     * exposing VtkVis to upper layers (MainWindow, PropertiesDelegate, etc.)
     */
...
protected:
    /**
     * @brief Get VtkVis instance (for VTK-specific operations)
     * @return Pointer to VtkVis, or nullptr if cast fails
     *
     ...
     */
    Visualization::VtkVis* getVtkVis() const;

    /**
     * @brief Check if visualizer is valid and is VtkVis
     * @return true if visualizer is set and is VtkVis instance
     */
    bool hasValidVtkVis() const;
