...
/**
 * @file cvGenericSelectionTool.h
 * @brief Base class for selection tools with picking capabilities (software
 ...
 */
class QVTK_ENGINE_LIB_API cvGenericSelectionTool : public cvSelectionBase {
public:
    /**
...
protected:
    // Note: Visualizer access methods (setVisualizer, getVisualizer, getVtkVis,
    // hasValidVtkVis, getAllPolyDataFromVisualizer)
