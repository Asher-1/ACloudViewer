...
/**
 * @file cvSelectionPipeline.h
 * @brief Selection pipeline abstraction for hardware-accelerated selection
 * operations (ParaView vtkSMSelectionHelper style).
 */
 ...
 */
class QVTK_ENGINE_LIB_API cvSelectionPipeline : public QObject {
    Q_OBJECT
