...
/**
 * @file cvSelectionHighlighter.h
 * @brief Selection highlighting and label visualization (ParaView
 * vtkSMPVRepresentationProxy style).
 */
 ...
 */
struct QVTK_ENGINE_LIB_API SelectionLabelProperties {
 ...
 */
class QVTK_ENGINE_LIB_API cvSelectionHighlighter
    : public QObject,
 ...
 */
class QVTK_ENGINE_LIB_API cvTooltipFormatter {
public:
    /**
