...
/**
 * @file cvDistanceTool.h
 * @brief Distance measurement tool for measuring between two points on mesh
 * surfaces.
 */
...
public:
    /**
     * @brief Construct the distance tool
    ...
    /**
     * @param state True to show the distance widget, false to hide
     */
