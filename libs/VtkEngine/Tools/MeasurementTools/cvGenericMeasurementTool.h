...
/**
 * @file cvGenericMeasurementTool.h
 * @brief Base class for measurement tools (distance, angle, contour) with
 * point picking, font properties, and VTK widget integration.
 */
 ...
 * @brief Base class for all measurement tools (distance, protractor, contour).
 *
 * Provides common functionality: point picking shortcuts, font properties
 * for labels, VTK interactor/renderer setup, and actor management.
 */
...
public:
    /**
     * @brief Construct the generic measurement tool
    ...
    /**
     * @return True if model initialization succeeded
     */
    virtual bool initModel();
    /**
     * @param obj Input entity (ccPointCloud or ccMesh)
