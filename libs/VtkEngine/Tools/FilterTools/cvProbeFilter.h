...
/**
 * @file cvProbeFilter.h
 * @brief Probe filter for sampling scalars along line, sphere, or plane.
 */
...
/**
 * @class cvProbeFilter
 * @brief Probes scalar values along line, sphere, or plane with plot widget.
 */
