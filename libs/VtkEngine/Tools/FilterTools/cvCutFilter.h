...
/**
 * @file cvCutFilter.h
 * @brief Base cut filter with box, plane, or sphere interactors.
 */
...
/**
 * @class cvCutFilter
 * @brief Base cut filter supporting box, plane, and sphere cut types.
 */
...
public:
    /// @param state If true, show interactor.
    ...
    /// @param trans Output transformation matrix.
