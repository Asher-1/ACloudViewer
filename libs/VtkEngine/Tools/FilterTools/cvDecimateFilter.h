...
/**
 * @file cvDecimateFilter.h
 * @brief Polygon decimation filter for mesh simplification.
 */
...
/**
 * @class cvDecimateFilter
 * @brief Reduces triangle count using vtkDecimatePro with configurable target
 * reduction.
 */
