...
/**
 * @file cvStreamlineFilter.h
 * @brief Streamline visualization filter for vector field data.
 */
...
/**
 * @class cvStreamlineFilter
 * @brief Generates streamlines from vector fields using vtkStreamTracer
 *        with interactive line/point source widgets.
 */
class vtkLineWidget;
