...
public:
     ...
     * ISO 639 language code in lowercase. e.g. CloudCompare_fr.ts
    ...
    //! Using the translation file prefixes that were registered, load the
    //! actual translations
    void loadTranslations();

    /** Using the translation file prefixes that were registered, load the
     * actual translation by the 2-letter ISO 639 language code in lowercase.
     */
    void loadTranslation(QString language);

    //! Populate the menu with a list of languages found using files in
...
private:
    ...
    //! Generate a list of available languages based on the files in the
