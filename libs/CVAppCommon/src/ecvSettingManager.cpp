...
//-----------------------------------------------------------------------------
void ecvSettingManager::saveState(const QMainWindow& window, const QString& key)
{
	this->beginGroup(key);
...
QVariant ecvSettingManager::getValue(const QString &section, const QString &key, const QVariant &defaultValue)
{
	s_manager.instance->m_iniFile->beginGroup(section);
...
{
	s_manager.instance->m_iniFile->clear();
}

void ecvSettingManager::sync()
{
	s_manager.instance->m_iniFile->sync();
}
...
QVariant ecvSettingManager::value(const QString & key, const QVariant & defaultValue) const
{
