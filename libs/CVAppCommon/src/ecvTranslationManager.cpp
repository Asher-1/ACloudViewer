...
{
	const LanguageList	cList = availableLanguages( QStringLiteral( "ErowCloudViewer" ), pathToTranslationFiles );
...
void ccTranslationManager::setLanguagePref( const QString &languageCode )
{
	...
	QMessageBox::information( nullptr, 
							  tr( "Language Change" ),
							  tr( "Language change will take effect when ErowCloudViewer is restarted" ) );
}
