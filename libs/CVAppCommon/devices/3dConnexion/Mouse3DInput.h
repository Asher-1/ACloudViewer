...
class CVAPPCOMMON_LIB_API Mouse3DInput : public QObject {
    Q_OBJECT
...
public:
    ...
    static void GetMatrix(const std::vector<float>& motionData,
                          ccGLMatrixd& mat);
...
protected:
    ...
    /** The default implementation emits a sigOn3dmouseKeyDown signal with the
     * key code.
     */
    ...
    /** The default implementation emits a sigOn3dmouseKeyUp signal with the key
     *code.
     **/
