...
struct CV_IO_LIB_API ReadPointCloudOption {
     ...
     * @note When updating defaults, also update docstrings in
     * pybind/io/class_io.cpp
     */
    ReadPointCloudOption(std::string format = "auto",
    ...
    std::function<bool(double)>
            update_progress;  ///< Progress callback (0-100%, return false to
                              ///< cancel)
};
