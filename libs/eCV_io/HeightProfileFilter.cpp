...
bool HeightProfileFilter::canSave(CV_CLASS_ENUM type, bool& multiple, bool& exclusive) const
{
...
CC_FILE_ERROR HeightProfileFilter::saveToFile(ccHObject* entity, const QString& filename, const SaveParameters& parameters)
{
	...
	{
		//invalid size
		CVLog::Warning(QString("[Height profile] Polyline '%1' is empty").arg(poly->getName()));
