...
bool MAFilter::canSave(CV_CLASS_ENUM type, bool& multiple, bool& exclusive) const
{
...
void ReleaseEdgeList(edge**& theEdges, unsigned numberOfVertexes, CVLib::NormalizedProgress* nprogress = 0)
{
