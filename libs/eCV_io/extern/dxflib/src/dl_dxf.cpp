...
/**
 * Adds a polyline entity that was read from the file via the creation
 * interface.
 */
...
/**
 * Adds an ellipse entity that was read from the file via the creation
 * interface.
 */
...
/**
 * Adds a trace entity (4 edge closed polyline) that was read from the file via
...
/**
 * Adds a solid entity (filled trace) that was read from the file via the
 * creation interface.
 *
 * @author AHM
 */
...
/**
 * Adds an arc aligned text entity that was read from the file via the creation
 * interface.
 */
...
/**
 * Adds a linear dimension entity that was read from the file via the creation
 * interface.
 */
...
/**
 * Adds an aligned dimension entity that was read from the file via the creation
 * interface.
 */
...
/**
 * Adds a radial dimension entity that was read from the file via the creation
 * interface.
 */
...
/**
 * Adds a diametric dimension entity that was read from the file via the
 * creation interface.
 */
...
/**
 * Adds an angular dimension entity that was read from the file via the creation
 * interface.
 */
...
/**
 * Adds an ordinate dimension entity that was read from the file via the
 * creation interface.
 */
...
/**
 * Adds an image definition that was read from the file via the creation
 * interface.
 */
...
/**
 * Writes the end of the objects section. This section is needed in
 * DL_VERSION_R13. Note that this method currently only writes a faked OBJECTS
 * section to make the file readable by Aut*cad.
 */
