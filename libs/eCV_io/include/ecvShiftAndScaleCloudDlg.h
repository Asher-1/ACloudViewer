...
class ECV_IO_LIB_API ecvShiftAndScaleCloudDlg : public QDialog {
    Q_OBJECT
...
public:
    ...
    (or <= 0 to ignore) \param parent parent widget
    **/
    ecvShiftAndScaleCloudDlg(const CCVector3d& Pg,
                             double Dg = 0,
                             QWidget* parent = 0);
    ...
    **/
    ecvShiftAndScaleCloudDlg(const CCVector3d& Pl,
                             double Dl,
                             const CCVector3d& Pg,
                             double Dg,
                             QWidget* parent = 0);
