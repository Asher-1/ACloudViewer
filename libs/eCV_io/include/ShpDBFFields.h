...
class ECV_IO_LIB_API IntegerDBFField : public GenericDBFField
{
public:
...
class ECV_IO_LIB_API DoubleDBFField : public GenericDBFField
{
public:
...
class ECV_IO_LIB_API DoubleDBFField3D : public GenericDBFField
{
public:
