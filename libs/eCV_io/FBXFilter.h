...
#ifndef ECV_FBX_FILTER_HEADER
#define ECV_FBX_FILTER_HEADER
...
**/
class ECV_IO_LIB_API FBXFilter : public FileIOFilter
{
public:
...
#endif // CV_FBX_SUPPORT

#endif // ECV_FBX_FILTER_HEADER
