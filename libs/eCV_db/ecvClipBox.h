...
//! Clipping box
class ECV_DB_LIB_API ccClipBox : public QObject, public ccHObject, public ccInteractor
{
	Q_OBJECT
...
public:
	...
	**/
	...
	//inherited from ccHObject
	inline CV_CLASS_ENUM getClassID() const override { return CV_TYPES::CLIPPING_BOX; }
