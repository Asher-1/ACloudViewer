...
public:
	...
	**/
	...
	//! Sets removeFlag
	virtual inline void setRemoveFlag(bool removeFlag) {m_removeFlag = removeFlag; }
	...
	**/
	...
	inline bool isKindOf(CV_CLASS_ENUM type) const { return (getClassID() & type) == type; }
...
protected:
	...
	//! Returns flag state
	virtual inline bool getFlagState(CV_OBJECT_FLAG flag) const { return (m_flags & flag); }
