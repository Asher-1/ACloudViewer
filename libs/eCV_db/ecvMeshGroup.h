...
public:
	...
	//! Returns class ID
	virtual CV_CLASS_ENUM getClassID() const override { return CV_TYPES::MESH_GROUP; }
	...
	virtual bool interpolateColors(unsigned triIndex, const CCVector3& P, ecvColor::Rgb& rgb) override { return false; }
	virtual bool getColorFromMaterial(unsigned triIndex, const CCVector3& P, ecvColor::Rgb& rgb, bool interpolateColorIfNoTexture) override { return false; }
	virtual bool getVertexColorFromMaterial(unsigned triIndex, unsigned char vertIndex, ecvColor::Rgb& rgb, bool returnColorIfNoTexture) override { return false; }
	...
	virtual bool trianglePicking(const CCVector2d& clickPos,
		...
		CCVector3d& nearestPoint) override { return false; }
