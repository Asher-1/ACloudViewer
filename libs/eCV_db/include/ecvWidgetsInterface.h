...
namespace DBLib
{
	...
	public:
		...
		static QWidget* LoadWidget(const VTK_WIDGETS_TYPE widgetType, Shared filter);

		static QWidget* LoadWidget(const VTK_WIDGETS_TYPE widgetType);

		static bool SetInput(const ccHObject * obj, const VTK_WIDGETS_TYPE widgetType);
	...
	public: //public interface (to be reimplemented by each widgets interface)
		...
		**/
		...
		virtual const QString getWidgtNameByID(const VTK_WIDGETS_TYPE widgetID) const = 0;
		...
		virtual bool setInput(const ccHObject * obj, const VTK_WIDGETS_TYPE widgetType) = 0;
