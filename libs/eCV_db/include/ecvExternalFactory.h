 ...
 *  Factories are then stored in a unique container and used to load custom
 *types.
 **/
class ECV_DB_LIB_API ccExternalFactory {
public:
    //! A convenience holder for all factories
    class ECV_DB_LIB_API Container {
    public:
        //! Default constructor
        Container() {}
        ...
        **/
        ...
        /** Any previously existing factory with the same name will be
         *overwritten.
         **/
        ...
        //! Returns the unqiue static instance of the external factories
        //! container
        static Container::Shared GetUniqueInstance();

        //! Sets the unqiue static instance of the external factories container
        /** A default static instance is provided for convenience but another
        user defined instance can be declared here instead.
        **/
    ...
    /** Similar to ccHObject::New but virtual so as to be reimplemented by the
    plugin. \param metaName custom object name \return corresponding instance
