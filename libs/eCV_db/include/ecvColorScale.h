...
public:
	...
	**/
	inline const ecvColor::Rgb* getColorByValue(double value, const ecvColor::Rgb* outOfRangeColor = nullptr) const
	{
		assert(m_updated && !m_relative);
	...
	/** \param relativePos relative position (should be in [0;1])
		...
		\return corresponding color
	**/
	inline const ecvColor::Rgb* getColorByRelativePos(double relativePos, const ecvColor::Rgb* outOfRangeColor = nullptr) const
	{
		assert(m_updated);
	...
	/** \param relativePos relative position (must be between 0 and 1!)
		...
		\return corresponding color
	**/
	inline const ecvColor::Rgb* getColorByRelativePos(double relativePos, unsigned steps, const ecvColor::Rgb* outOfRangeColor = nullptr) const
	{
		assert(m_updated);
		if (relativePos >= 0.0 && relativePos <= 1.0)
		{
