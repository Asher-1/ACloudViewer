...
/** 3D cone primitive
 **/
class ECV_DB_LIB_API ccCone : public ccGenericPrimitive {
public:
    ...
    /** Cone axis corresponds to the 'Z' dimension by default
            ...
            \param height cone height (transformation should point to the axis
    center) \param xOff displacement of axes along X-axis (Snout mode) \param
    yOff displacement of axes along Y-axis (Snout mode) \param transMat optional
    ...
    **/
    ...
    //! Returns class ID
    virtual CV_CLASS_ENUM getClassID() const override { return CV_TYPES::CONE; }
