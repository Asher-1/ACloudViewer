...
public:
    ...
    **/
    ...
    /** Adapted from  "Efficiently Building a Matrix to Rotate One Vector to
    Another" By Tomas Möller, John Hughes, Journal of Graphics Tools, 4(4):1-4,
    1999 \param from normalized non-zero source vector \param to normalized
    non-zero destination vector
    **/
    ...
    **/
    ...
    //! Returns equivalent parameters: a rotation axis, an angle and a
    //! translation
    /** \param[out] alpha_rad rotation angle in radians (in [0;pi])
            \param[out] axis3D unit rotation axis
    ...
    **/
    ...
    /** \param Rt Rotation matrix as a float array
     **/
    ...
    /** \param Rt Rotation matrix as a double array
     **/
    ...
    **/
    ...
    //! Get the resulting transformation along the 4th dimension (double
    //! version)
