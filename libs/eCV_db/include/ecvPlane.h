...
/** 3D plane primitive
**/
class ECV_DB_LIB_API ccPlane : public ccGenericPrimitive, public ccPlanarEntityInterface
{
public:
	...
	**/
	...
	//! Returns class ID
	virtual CV_CLASS_ENUM getClassID() const override { return CV_TYPES::PLANE; }
