...
public:
    ...
    //! Returns whether the structure is null (i.e. not under construction or
    //! initialized) or not
...
protected:  // methods
    ...
    /** \return the new cell index in the array corresponding to this level (see
     *m_levels)
     **/
    ...
    /** All nodes are flagged as 'INSIDE' (= visible) and their 'visibleCount'
     *attribute is set to 0.
     **/
    void resetVisibility();

    //! Adds a given number of points to the active index map (should be
    //! dispatched among the children cells)
