...
public: //general
	...
	struct ECV_DB_LIB_API RadialDistortionParameters : LensDistortionParameters
	{
		//! Shared pointer type
	...
	struct ECV_DB_LIB_API ExtendedRadialDistortionParameters : RadialDistortionParameters
	{
		//! Shared pointer type
		typedef QSharedPointer<RadialDistortionParameters> Shared;
