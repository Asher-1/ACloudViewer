...
class ECV_DB_LIB_API cc2DLabel : public ccHObject, public ccInteractor {
public:
    //! Default constructor
    ...
    **/
    bool addPickedPoint(ccGenericPointCloud* cloud,
                        unsigned pointIndex,
    ...
    /** Adding a point to a label will automatically make it 'mutate'.
            ...
            \return false if 'full'
    **/
    bool addPickedPoint(ccGenericMesh* mesh,
     ...
     **/
    struct ECV_DB_LIB_API PickedPoint {
        //! Cloud
        ...
        //! Returns the item 'title' (either its index or 'Center' if it's a
        //! center point)
        ...
        PickedPoint(ccGenericPointCloud* _cloud,
                    unsigned pointIndex,
        ...
        PickedPoint(ccGenericMesh* _mesh,
                    unsigned triIindex,
