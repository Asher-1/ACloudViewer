...
**/
class ccScalarField : public CVLib::ScalarField, public ccSerializableObject
{
public:
	...
	**/
	ECV_DB_LIB_API explicit ccScalarField(const char* name = nullptr);

	//! Copy constructor
	/** \param sf scalar field to copy
		\warning May throw a std::bad_alloc exception
	**/
	ECV_DB_LIB_API ccScalarField(const ccScalarField& sf);

	/*** Scalar values display handling ***/

	//! Scalar field range structure
	class ECV_DB_LIB_API Range
	{
	public:
	...
	protected:
        ...
        inline void updateRange() { m_range = std::max(m_stop - m_start, ZERO_TOLERANCE_SCALAR); }
	...
	**/
	...
	ECV_DB_LIB_API void setMinDisplayed(ScalarType val);
	//! Sets the maximum displayed value
	ECV_DB_LIB_API void setMaxDisplayed(ScalarType val);
	//! Sets the value at which to start color gradient
	ECV_DB_LIB_API void setSaturationStart(ScalarType val);
	//! Sets the value at which to stop color gradient
	ECV_DB_LIB_API void setSaturationStop(ScalarType val);
	...
	**/
	...
	{
		assert(m_colorScale);
		return m_colorScale->getColorByRelativePos(normalize(value), m_colorRampSteps, m_showNaNValuesInGrey ? &ecvColor::lightGrey : nullptr);
	}
	...
	ECV_DB_LIB_API void alwaysShowZero(bool state);
	...
	**/
	ECV_DB_LIB_API void setSymmetricalScale(bool state);
	...
	**/
	...
	ECV_DB_LIB_API void setColorScale(ccColorScale::Shared scale);
	...
	ECV_DB_LIB_API void setColorRampSteps(unsigned steps);
	...
	**/
	ECV_DB_LIB_API bool mayHaveHiddenValues() const;
	...
	ECV_DB_LIB_API void importParametersFrom(const ccScalarField* sf);

	//inherited from ccSerializableObject
	inline bool isSerializable() const override { return true; }
	ECV_DB_LIB_API bool toFile(QFile& out) const override;
	ECV_DB_LIB_API bool fromFile(QFile& in, short dataVersion, int flags) override;
...
protected: //methods
	...
	**/
	...
	ECV_DB_LIB_API void updateSaturationBounds();
	...
	**/
	ECV_DB_LIB_API ScalarType normalize(ScalarType val) const;
