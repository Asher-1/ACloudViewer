...
#define MACRO_DrawEntityNames(context) \
    (context.drawingFlags & CC_DRAW_ENTITY_NAMES)
#define MACRO_DrawFastNamesOnly(context) \
    (context.drawingFlags & CC_DRAW_FAST_NAMES_ONLY)
