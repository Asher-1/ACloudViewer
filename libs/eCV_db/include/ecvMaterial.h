...
public:
	...
	inline void setDiffuseFront(const ecvColor::Rgbaf& color) { m_diffuseFront = color; }
	//! Sets diffuse color (back)
	inline void setDiffuseBack(const ecvColor::Rgbaf& color) { m_diffuseBack = color; }
	//! Returns front diffuse color
	inline const ecvColor::Rgbaf& getDiffuseFront() const { return m_diffuseFront; }
	//! Returns back diffuse color
	inline const ecvColor::Rgbaf& getDiffuseBack() const { return m_diffuseBack; }
	...
	//! Sets emission color
	inline void setEmission(const ecvColor::Rgbaf& color) { m_emission = color; }
