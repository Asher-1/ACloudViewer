...
class ECV_DB_LIB_API ecvDisplayTools : public QObject, public GenericDispalyTools
{
	Q_OBJECT
public:
	/**
...
public: // visualization matrix transformation
	...
	**/
	...
	inline virtual bool getPerspectiveState() { return TheInstance()->m_viewportParams.perspectiveView; }
