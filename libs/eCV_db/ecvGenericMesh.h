...
public:
	...
	**/
	...
	virtual bool getTriangleNormals(unsigned triangleIndex, double Na[3], double Nb[3], double Nc[3]) const { return false; };
	virtual bool getTriangleNormals(unsigned triangleIndex, Eigen::Vector3d& Na, Eigen::Vector3d& Nb, Eigen::Vector3d& Nc) const { return false; };
