...
QStringList FiltersWidgetInterface::getWidgtsNames() const
{
	...
	widgetsName << "clipWidget" << "sliceWidget" << "isosurfaceWidget" << "thresholdWidget"
		<< "streamlineWidget" << "glyphWidget"<< "probeWidget" << "smootWidget" << "decimateWidget" ;
	return widgetsName;
}
...
QWidget * FiltersWidgetInterface::getWidgtByID(const VTK_WIDGETS_TYPE widgetID) const
{
...
const QString FiltersWidgetInterface::getWidgtNameByID(const VTK_WIDGETS_TYPE widgetID) const
{
...
bool FiltersWidgetInterface::setInput(const ccHObject * obj, const VTK_WIDGETS_TYPE widgetType)
{
...
ccHObject * FiltersWidgetInterface::getOutput(const DBLib::VTK_WIDGETS_TYPE widgetType)
{
	...
	FilterWindow * filterWin = static_cast<FilterWindow *>(getWidgtByID(widgetType));
	if (!filterWin)
	{
		return nullptr;
	}
...
void FiltersWidgetInterface::initWidgets()
{
	...
	for (QString & name : widgetNames)
	{
		...
		{
			m_widgetsMap.insert(VTK_WIDGETS_TYPE::VTK_CLIP_WIDGET, new ClipWindow);
			m_NamesMap.insert(VTK_WIDGETS_TYPE::VTK_CLIP_WIDGET, name);
		}
		else if (name == QString("sliceWidget"))
		{
			m_widgetsMap.insert(VTK_WIDGETS_TYPE::VTK_SLICE_WIDGET, new SliceWindow);
			m_NamesMap.insert(VTK_WIDGETS_TYPE::VTK_SLICE_WIDGET, name);
		}
		/*else if (name == QString("isosurfaceWidget"))
		{
			m_widgetsMap.insert(VTK_WIDGETS_TYPE::VTK_ISOSURFACE_WIDGET, new IsosurfaceWindow);
			m_NamesMap.insert(VTK_WIDGETS_TYPE::VTK_ISOSURFACE_WIDGET, name);
		}
		else if (name == QString("thresholdWidget"))
		{
			m_widgetsMap.insert(VTK_WIDGETS_TYPE::VTK_THRESHOLD_WIDGET, new ThresholdWindow);
			m_NamesMap.insert(VTK_WIDGETS_TYPE::VTK_THRESHOLD_WIDGET, name);
		}
		else if (name == QString("streamlineWidget"))
		{
			m_widgetsMap.insert(VTK_WIDGETS_TYPE::VTK_STREAMLINE_WIDGET, new StreamlineWindow);
			m_NamesMap.insert(VTK_WIDGETS_TYPE::VTK_STREAMLINE_WIDGET, name);
		}
		else if (name == QString("glyphWidget"))
		{
			m_widgetsMap.insert(VTK_WIDGETS_TYPE::VTK_GLYPH_WIDGET, new GlyphWindow);
			m_NamesMap.insert(VTK_WIDGETS_TYPE::VTK_GLYPH_WIDGET, name);
		}
		else if (name == QString("probeWidget"))
		{
			m_widgetsMap.insert(VTK_WIDGETS_TYPE::VTK_PROB_WIDGET, new ProbeWindow);
			m_NamesMap.insert(VTK_WIDGETS_TYPE::VTK_PROB_WIDGET, name);

		}
		else if (name == QString("smootWidget"))
		{
			m_widgetsMap.insert(VTK_WIDGETS_TYPE::VTK_SMOOTH_WIDGET, new SmoothWindow);
			m_NamesMap.insert(VTK_WIDGETS_TYPE::VTK_SMOOTH_WIDGET, name);
		}
		else if (name == QString("decimateWidget"))
		{
			m_widgetsMap.insert(VTK_WIDGETS_TYPE::VTK_DECIMATEWIDGET_WIDGET, new DecimateWindow);
			m_NamesMap.insert(VTK_WIDGETS_TYPE::VTK_DECIMATEWIDGET_WIDGET, name);
		}*/
	}
}
