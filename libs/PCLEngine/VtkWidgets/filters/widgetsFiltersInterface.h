...
class QPCL_ENGINE_LIB_API FiltersWidgetInterface
    : public QObject,
      public DBLib::ecvWidgetsInterface {
    Q_OBJECT
...
public:
    ...
    virtual QWidget* getWidgtByID(
            const DBLib::VTK_WIDGETS_TYPE widgetID) const override;
    ...
    virtual bool setInput(const ccHObject* obj,
                          const DBLib::VTK_WIDGETS_TYPE widgetType) override;
