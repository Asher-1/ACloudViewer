...
PclUtils::ImageViewerInteractorStyle::ImageViewerInteractorStyle() {}

void PclUtils::ImageViewerInteractorStyle::OnChar() {
...
void PclUtils::ImageViewerInteractorStyle::adjustCamera(vtkRenderer* ren) {
    vtkCamera* camera = ren->GetActiveCamera();
...
void PclUtils::ImageViewerInteractorStyle::OnLeftButtonDown() {
...
// ImageViewer
// ============================================================================
PclUtils::ImageViewer::ImageViewer(const std::string& window_title)
...
// Spin
// ------------------------------------------------------------------
void PclUtils::ImageViewer::spin() {
    render();
    resetStoppedFlag();
    interactor_->Start();
}

void PclUtils::ImageViewer::spinOnce(int time, bool force_redraw) {
    if (force_redraw) render();
    if (time <= 0) time = 1;
...
void PclUtils::ImageViewer::emitMouseEvent(unsigned long event_id) {
...
void PclUtils::ImageViewer::emitKeyboardEvent(unsigned long event_id) {
...
void PclUtils::ImageViewer::removeLayer(const std::string& layer_id) {
    LayerMap::iterator am_it = std::find_if(
            layer_map_.begin(), layer_map_.end(), LayerComparator(layer_id));
    if (am_it == layer_map_.end()) return;
...
// Window management
// ------------------------------------------------------------------
void PclUtils::ImageViewer::render() {
    win_->Render();
    for (auto& i : image_data_) delete[] i;
    image_data_.clear();
}

void PclUtils::ImageViewer::setWindowTitle(const std::string& name) {
    win_->SetWindowName(name.c_str());
}

void PclUtils::ImageViewer::setPosition(int x, int y) {
    win_->SetPosition(x, y);
}

int* PclUtils::ImageViewer::getSize() { return win_->GetSize(); }

void PclUtils::ImageViewer::setSize(int xw, int yw) { win_->SetSize(xw, yw); }
