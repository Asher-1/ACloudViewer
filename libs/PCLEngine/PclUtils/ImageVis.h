...
public:
     ...
     * @param autoInit Whether to automatically initialize VTK components
     * (default: false)
     *
     * Creates a new 2D image viewer with multi-layer support.
     *
     * @note Constructor is public but may be used with care to ensure proper
     * initialization.
     */
     ...
     *
     * Checks whether an image layer with the given ID has been added to the
     * visualizer.
     */
     ...
     * @param fill_box Whether to initialize with black background (default:
     * true)
...
private:
    ...
    /// Prevents crashes when getCamera is called on
