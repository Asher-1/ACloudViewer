...
pcl::visualization::ImageViewer::ImageViewer(const std::string& window_title)
    ...
    vtkSmartPointer<vtkImageData> empty_image =
...
//////////////////////////////////////////////////////////////////////////////////////////
void pcl::visualization::ImageViewer::addRGBImage(const unsigned char* rgb_data,
                                                  unsigned width,
                                                  unsigned height,
    ...
    if (am_it == layer_map_.end()) {
        PCL_DEBUG(
                "[pcl::visualization::ImageViewer::addRGBImage] No layer with "
...
//////////////////////////////////////////////////////////////////////////////////////////
void pcl::visualization::ImageViewer::showRGBImage(
...
//////////////////////////////////////////////////////////////////////////////////////////
void pcl::visualization::ImageViewer::addMonoImage(
        const unsigned char* rgb_data,
        unsigned width,
        unsigned height,
        const std::string& layer_id,
    ...
    if (am_it == layer_map_.end()) {
        PCL_DEBUG(
                "[pcl::visualization::ImageViewer::showMonoImage] No layer "
                "with ID='%s' found. Creating new one...\n",
                layer_id.c_str());
        am_it = createLayer(layer_id, width, height, opacity, false);
    }
...
//////////////////////////////////////////////////////////////////////////////////////////
void pcl::visualization::ImageViewer::showMonoImage(
        const unsigned char* rgb_data,
        unsigned width,
        unsigned height,
        const std::string& layer_id,
...
//////////////////////////////////////////////////////////////////////////////////////////
void pcl::visualization::ImageViewer::addFloatImage(const float* float_image,
                                                    unsigned int width,
                                                    unsigned int height,
                                                    float min_value,
                                                    float max_value,
...
//////////////////////////////////////////////////////////////////////////////////////////
void pcl::visualization::ImageViewer::showFloatImage(
...
//////////////////////////////////////////////////////////////////////////////////////////
void pcl::visualization::ImageViewer::addAngleImage(const float* angle_image,
                                                    unsigned int width,
                                                    unsigned int height,
                                                    const std::string& layer_id,
                                                    double opacity) {
...
//////////////////////////////////////////////////////////////////////////////////////////
void pcl::visualization::ImageViewer::showAngleImage(
...
//////////////////////////////////////////////////////////////////////////////////////////
void pcl::visualization::ImageViewer::addHalfAngleImage(
        const float* angle_image,
        unsigned int width,
        unsigned int height,
        const std::string& layer_id,
        double opacity) {
    unsigned char* rgb_image = FloatImageUtils::getVisualHalfAngleImage(
...
//////////////////////////////////////////////////////////////////////////////////////////
void pcl::visualization::ImageViewer::showHalfAngleImage(
        const float* angle_image,
        unsigned int width,
        unsigned int height,
        const std::string& layer_id,
...
//////////////////////////////////////////////////////////////////////////////////////////
void pcl::visualization::ImageViewer::addShortImage(
...
//////////////////////////////////////////////////////////////////////////////////////////
void pcl::visualization::ImageViewer::showShortImage(
        const unsigned short* short_image,
        unsigned int width,
        unsigned int height,
        unsigned short min_value,
...
//////////////////////////////////////////////////////////////////////////////////////////
void pcl::visualization::ImageViewer::spinOnce(int time, bool force_redraw) {
    if (force_redraw) {
        render();
        // interactor_->Render ();
    }
    ...
    DO_EVERY(1.0 / interactor_->GetDesiredUpdateRate(),
             ...
             interactor_->Start(); interactor_->DestroyTimer(
                     exit_main_loop_timer_callback_->right_timer_id););
    for (auto& i : image_data_) delete[] i;
    image_data_.clear();
}
...
pcl::visualization::ImageViewer::registerMouseCallback(
    ...
    if (mouse_signal_.empty()) {
        interactor_->GetInteractorStyle()->AddObserver(
                vtkCommand::MouseMoveEvent, mouse_command_);
        interactor_->GetInteractorStyle()->AddObserver(
                vtkCommand::MiddleButtonPressEvent, mouse_command_);
        interactor_->GetInteractorStyle()->AddObserver(
                vtkCommand::MiddleButtonReleaseEvent, mouse_command_);
        interactor_->GetInteractorStyle()->AddObserver(
                vtkCommand::MouseWheelBackwardEvent, mouse_command_);
        interactor_->GetInteractorStyle()->AddObserver(
                vtkCommand::MouseWheelForwardEvent, mouse_command_);
        interactor_->GetInteractorStyle()->AddObserver(
                vtkCommand::LeftButtonPressEvent, mouse_command_);
        interactor_->GetInteractorStyle()->AddObserver(
                vtkCommand::LeftButtonReleaseEvent, mouse_command_);
        interactor_->GetInteractorStyle()->AddObserver(
                vtkCommand::RightButtonPressEvent, mouse_command_);
        interactor_->GetInteractorStyle()->AddObserver(
...
pcl::visualization::ImageViewer::registerKeyboardCallback(
    ...
    if (keyboard_signal_.empty()) {
        ...
        interactor_->AddObserver(vtkCommand::KeyReleaseEvent,
                                 keyboard_command_);
    }
...
void pcl::visualization::ImageViewer::emitMouseEvent(unsigned long event_id) {
    ...
    switch (event_id) {
        ...
        case vtkCommand::MouseWheelBackwardEvent:
            ...
            if (interactor_->GetRepeatCount() != 0) repeat = true;
            break;
    ...
    mouse_signal_(event);
    if (repeat) mouse_signal_(event);
}

//////////////////////////////////////////////////////////////////////////////////////////
void pcl::visualization::ImageViewer::emitKeyboardEvent(
...
pcl::visualization::ImageViewer::createLayer(const std::string& layer_id,
                                             int width,
                                             int height,
                                             double opacity,
                                             bool fill_box) {
...
bool pcl::visualization::ImageViewer::addLayer(const std::string& layer_id,
    ...
    if (am_it != layer_map_.end()) {
        PCL_DEBUG(
                "[pcl::visualization::ImageViewer::addLayer] Layer with "
                "ID='%s' already exists!\n",
                layer_id.c_str());
        return (false);
    }
...
void pcl::visualization::ImageViewer::removeLayer(const std::string& layer_id) {
    ...
    if (am_it == layer_map_.end()) {
        PCL_DEBUG(
                "[pcl::visualization::ImageViewer::removeLayer] No layer with "
                "ID='%s' found.\n",
                layer_id.c_str());
        return;
    }
...
bool pcl::visualization::ImageViewer::addCircle(unsigned int x,
    ...
    if (am_it == layer_map_.end()) {
        PCL_DEBUG(
                "[pcl::visualization::ImageViewer::addCircle] No layer with "
                "ID='%s' found. Creating new one...\n",
                layer_id.c_str());
...
//////////////////////////////////////////////////////////////////////////////////////////
bool pcl::visualization::ImageViewer::addFilledRectangle(
        unsigned int x_min,
        unsigned int x_max,
        unsigned int y_min,
        unsigned int y_max,
    ...
    if (am_it == layer_map_.end()) {
        PCL_DEBUG(
                "[pcl::visualization::ImageViewer::addFilledRectangle] No "
                "layer with ID='%s' found. Creating new one...\n",
                layer_id.c_str());
        am_it = createLayer(layer_id, getSize()[0] - 1, getSize()[1] - 1,
                            opacity, false);
    }
...
bool pcl::visualization::ImageViewer::addRectangle(unsigned int x_min,
    ...
    if (am_it == layer_map_.end()) {
        PCL_DEBUG(
                "[pcl::visualization::ImageViewer::addRectangle] No layer with "
                "ID='%s' found. Creating new one...\n",
                layer_id.c_str());
        am_it = createLayer(layer_id, getSize()[0] - 1, getSize()[1] - 1,
                            opacity, false);
...
bool pcl::visualization::ImageViewer::addLine(unsigned int x_min,
    ...
    if (am_it == layer_map_.end()) {
        PCL_DEBUG(
                "[pcl::visualization::ImageViewer::addLine] No layer with "
                "ID='%s' found. Creating new one...\n",
                layer_id.c_str());
        am_it = createLayer(layer_id, getSize()[0] - 1, getSize()[1] - 1,
                            opacity, false);
...
void pcl::visualization::ImageViewer::markPoint(std::size_t u,
    ...
    if (am_it == layer_map_.end()) {
        PCL_DEBUG(
                "[pcl::visualization::ImageViewer::markPoint] No layer with "
                "ID='%s' found. Creating new one...\n",
                layer_id.c_str());
        am_it = createLayer(layer_id, getSize()[0] - 1, getSize()[1] - 1,
                            opacity, false);
...
//////////////////////////////////////////////////////////////////////////////////////////
void pcl::visualization::ImageViewer::convertIntensityCloudToUChar(
        const pcl::PointCloud<pcl::Intensity>& cloud,
...
//////////////////////////////////////////////////////////////////////////////////////////
void pcl::visualization::ImageViewer::convertIntensityCloud8uToUChar(
        const pcl::PointCloud<pcl::Intensity8u>& cloud,
        boost::shared_array<unsigned char> data) {
    int j = 0;
    for (const auto& point : cloud.points)
...
//////////////////////////////////////////////////////////////////////////////////////////
void pcl::visualization::ImageViewerInteractorStyle::OnChar() {
...
//////////////////////////////////////////////////////////////////////////////////////////
void pcl::visualization::ImageViewerInteractorStyle::adjustCamera(
...
//////////////////////////////////////////////////////////////////////////////////////////
void pcl::visualization::ImageViewerInteractorStyle::OnLeftButtonDown() {
...
//////////////////////////////////////////////////////////////////////////////////////////
void pcl::visualization::ImageViewer::setPosition(int x, int y) {
    win_->SetPosition(x, y);
}

//////////////////////////////////////////////////////////////////////////////////////////
int* pcl::visualization::ImageViewer::getSize() { return (win_->GetSize()); }

//////////////////////////////////////////////////////////////////////////////////////////
void pcl::visualization::ImageViewer::setSize(int xw, int yw) {
    win_->SetSize(xw, yw);
}
