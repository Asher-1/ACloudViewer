 ...
 *
 * Features include:
 *  - add and remove different layers with different opacity (transparency)
 * values
...
public:
    ...
    /** \brief Set up the interactor style. By default the interactor style is
     * set to vtkInteractorStyleImage you can use this to set it to another
     * type. \param[in] style user set interactor style.
     */
     ...
     * spin/spinOnce to update). \param[in] data the input data representing the
     * image \param[in] width the width of the image \param[in] height the
     * height of the image \param[in] layer_id the name of the layer (default:
    ...
    /** \brief Add a monochrome 2D image layer, but do not render it (use
     * spin/spinOnce to update). \param[in] cloud the input data representing
     * the grayscale point cloud \param[in] layer_id the name of the layer
     * (default: "image") \param[in] opacity the opacity of the layer
     * (default: 1.0)
     */
    ...
    /** \brief Add a monochrome 2D image layer, but do not render it (use
     * spin/spinOnce to update). \param[in] cloud the input data representing
     * the RGB point cloud \param[in] layer_id the name of the layer (default:
     * "image") \param[in] opacity the opacity of the layer (default: 1.0)
     */
    ...
    /** \brief Add an RGB 2D image layer, but do not render it (use
     * spin/spinOnce to update). \param[in] data the input data representing the
     * image \param[in] width the width of the image \param[in] height the
     * height of the image \param[in] layer_id the name of the layer (default:
     * "image") \param[in] opacity the opacity of the layer (default: 1.0)
     * \param[in] autoresize flag to enable window to adapt to image size
     * (default true)
     */
    ...
    /** \brief Show a 2D image on screen, obtained from the RGB channel of a
     * point cloud. \param[in] cloud the input data representing the RGB point
     * cloud \param[in] layer_id the name of the layer (default: "image")
     * \param[in] opacity the opacity of the layer (default: 1.0)
     */
    template <typename T>
     ...
     * \param[in] width the width of the image
     * \param[in] height the height of the image
     * \param[in] min_value filter all values in the image to be larger than
     * this minimum value \param[in] max_value filter all values in the image to
     * be smaller than this maximum value \param[in] grayscale show data as
     * grayscale (true) or not (false). Default: false \param[in] layer_id the
     * name of the layer (default: "image") \param[in] opacity the opacity of
     * the layer (default: 1.0)
     */
    ...
    /** \brief Add a float 2D image layer, but do not render it (use
     * spin/spinOnce to update). \param[in] data the input data representing the
     * image in float format \param[in] width the width of the image \param[in]
     * height the height of the image \param[in] min_value filter all values in
     * the image to be larger than this minimum value \param[in] max_value
     * filter all values in the image to be smaller than this maximum value
     * \param[in] grayscale show data as grayscale (true) or not (false).
     * Default: false \param[in] layer_id the name of the layer (default:
     * "image") \param[in] opacity the opacity of the layer (default: 1.0)
     */
     ...
     * \param[in] short_image the input data representing the image in unsigned
     * short format \param[in] width the width of the image \param[in] height
     * the height of the image \param[in] min_value filter all values in the
     * image to be larger than this minimum value \param[in] max_value filter
     * all values in the image to be smaller than this maximum value \param[in]
     * grayscale show data as grayscale (true) or not (false). Default: false
     * \param[in] layer_id the name of the layer (default: "image")
     * \param[in] opacity the opacity of the layer (default: 1.0)
     */
    ...
    /** \brief Add a short 2D image layer, but do not render it (use
     * spin/spinOnce to update). \param[in] short_image the input data
     * representing the image in unsigned short format \param[in] width the
     * width of the image \param[in] height the height of the image \param[in]
     * min_value filter all values in the image to be larger than this minimum
     * value \param[in] max_value filter all values in the image to be smaller
     * than this maximum value \param[in] grayscale show data as grayscale
     * (true) or not (false). Default: false \param[in] layer_id the name of the
     * layer (default: "image") \param[in] opacity the opacity of the layer
     * (default: 1.0)
     */
    ...
    /** \brief Add an angle 2D image layer, but do not render it (use
     * spin/spinOnce to update). \param[in] data the input data representing the
     * image \param[in] width the width of the image \param[in] height the
     * height of the image \param[in] layer_id the name of the layer (default:
     * "image") \param[in] opacity the opacity of the layer (default: 1.0)
    ...
    /** \brief Add a half angle 2D image layer, but do not render it (use
     * spin/spinOnce to update). \param[in] data the input data representing the
     * image \param[in] width the width of the image \param[in] height the
     * height of the image \param[in] layer_id the name of the layer (default:
     * "image") \param[in] opacity the opacity of the layer (default: 1.0)
     ...
     * neighborhood to another \param[in] u the u/x coordinate of the pixel
    ...
    /** \brief Sets the pixel at coordinates(u,v) to color while setting the
     * neighborhood to another \param[in] uv the u/x, v/y coordinate of the
     * pixels to be marked \param[in] fg_color the pixel color \param[in]
     * bg_color the neighborhood color \param[in] size edge of the square
     * surrounding each pixel \param[in] layer_id the name of the layer
     * (default: "markers") \param[in] opacity the opacity of the layer
     * (default: 1.0)
     */
    ...
    /** \brief Sets the pixel at coordinates(u,v) to color while setting the
     * neighborhood to another (float coordinates version). \param[in] uv the
     * u/x, v/y coordinate of the pixels to be marked \param[in] fg_color the
     * pixel color \param[in] bg_color the neighborhood color \param[in] size
     * edge of the square surrounding each pixel \param[in] layer_id the name of
     * the layer (default: "markers") \param[in] opacity the opacity of the
     * layer (default: 1.0)
     */
     ...
     * allowed to run. \param[in] force_redraw - if false it might return
     * without doing anything if the interactor's framerate does not require a
     * redraw yet.
     */
    void spinOnce(int time = 1, bool force_redraw = true);

    /** \brief Register a callback function for keyboard events
     * \param[in] callback  the function that will be registered as a callback
     * for a keyboard event \param[in] cookie    user data that is passed to the
     * callback \return a connection object that allows to disconnect the
     * callback function.
     */
    ...
    /** \brief Register a callback function for keyboard events
     * \param[in] callback  the member function that will be registered as a
     * callback for a keyboard event \param[in] instance  instance to the class
     * that implements the callback function \param[in] cookie    user data that
     * is passed to the callback \return a connection object that allows to
     ...
     * \param[in] cb the boost function that will be registered as a callback
     * for a keyboard event \return a connection object that allows to
     * disconnect the callback function.
     */
    boost::signals2::connection registerKeyboardCallback(
     ...
     * \param[in] callback  the function that will be registered as a callback
     * for a mouse event \param[in] cookie    user data that is passed to the
     * callback \return a connection object that allows to disconnect the
     * callback function.
     */
     ...
     * \param[in] callback  the member function that will be registered as a
     * callback for a mouse event \param[in] instance  instance to the class
     * that implements the callback function \param[in] cookie    user data that
     * is passed to the callback \return a connection object that allows to
     * disconnect the callback function.
     */
    ...
    /** \brief Register a callback function for mouse events
     * \param[in] cb the boost function that will be registered as a callback
     * for a mouse event \return a connection object that allows to disconnect
     ...
     * \param[in] layer_id the 2D layer ID where we want the extra information
     * to be drawn. \param[in] opacity the opacity of the layer: 0 for
     * invisible, 1 for opaque. (default: 1.0)
     */
     ...
     * \param[in] y the y coordinate of the circle center
     * \param[in] radius the radius of the circle
     * \param[in] r the red channel of the color that the sphere should be
     * rendered with (0.0 -> 1.0) \param[in] g the green channel of the color
     * that the sphere should be rendered with (0.0 -> 1.0) \param[in] b the
     * blue channel of the color that the sphere should be rendered with (0.0
     * -> 1.0) \param[in] layer_id the 2D layer ID where we want the extra
     * information to be drawn. \param[in] opacity the opacity of the layer: 0
     * for invisible, 1 for opaque. (default: 1.0)
     */
    bool addCircle(unsigned int x,
                   unsigned int y,
                   double radius,
     ...
     * \param[in] min_pt the X,Y min coordinate
     * \param[in] max_pt the X,Y max coordinate
     * \param[in] r the red channel of the color that the box should be rendered
     * with (0.0 -> 1.0) \param[in] g the green channel of the color that the
     * box should be rendered with (0.0 -> 1.0) \param[in] b the blue channel of
     * the color that the box should be rendered with (0.0 -> 1.0) \param[in]
     * layer_id the 2D layer ID where we want the extra information to be drawn.
    ...
    /** \brief Add a 2D box and color its edges with a given color
     * \param[in] image the organized point cloud dataset containing the image
     * data \param[in] min_pt the X,Y min coordinate \param[in] max_pt the X,Y
     * max coordinate \param[in] layer_id the 2D layer ID where we want the
     * extra information to be drawn. \param[in] opacity the opacity of the
     * layer: 0 for invisible, 1 for opaque. (default: 1.0)
     */
    template <typename T>
     ...
     * \param[in] image the organized point cloud dataset containing the image
     * data \param[in] min_pt the X,Y min coordinate \param[in] max_pt the X,Y
     * max coordinate \param[in] r the red channel of the color that the box
     * should be rendered with (0.0 -> 1.0) \param[in] g the green channel of
     * the color that the box should be rendered with (0.0 -> 1.0) \param[in] b
     * the blue channel of the color that the box should be rendered with (0.0
     * -> 1.0) \param[in] layer_id the 2D layer ID where we want the extra
     * information to be drawn. \param[in] opacity the opacity of the layer: 0
     * for invisible, 1 for opaque. (default: 1.0)
     */
     ...
     * \param[in] image the organized point cloud dataset containing the image
     * data \param[in] mask the point data representing the mask that we want to
     * draw \param[in] r the red channel of the color that the mask should be
     * rendered with \param[in] g the green channel of the color that the mask
     * should be rendered with \param[in] b the blue channel of the color that
     * the mask should be rendered with \param[in] layer_id the 2D layer ID
     * where we want the extra information to be drawn. \param[in] opacity the
    ...
    /** \brief Add a 2D box that contains a given image mask and color its edges
     * in red \param[in] image the organized point cloud dataset containing the
     * image data \param[in] mask the point data representing the mask that we
     * want to draw \param[in] layer_id the 2D layer ID where we want the extra
     * information to be drawn. \param[in] opacity the opacity of the layer: 0
     * for invisible, 1 for opaque. (default: 1.0)
     */
    template <typename T>
     ...
     * \param[in] layer_id the 2D layer ID where we want the extra information
     * to be drawn. \param[in] opacity the opacity of the layer: 0 for
     * invisible, 1 for opaque. (default: 0.5)
     */
     ...
     * \param[in] x_max the X max coordinate
     * \param[in] y_max the Y max coordinate
     * \param[in] r the red channel of the color that the line should be
     * rendered with (0.0 -> 1.0) \param[in] g the green channel of the color
     * that the line should be rendered with (0.0 -> 1.0) \param[in] b the blue
     * channel of the color that the line should be rendered with (0.0 -> 1.0)
     * \param[in] layer_id the 2D layer ID where we want the extra information
     * to be drawn. \param[in] opacity the opacity of the layer: 0 for
     * invisible, 1 for opaque. (default: 1.0)
     */
     ...
     * the mask should be rendered with \param[in] layer_id the 2D layer ID
     * where we want the extra information to be drawn. \param[in] opacity the
     * opacity of the layer: 0 for invisible, 1 for opaque. (default: 0.5)
     */
    template <typename T>
     ...
     * \param[in] image the organized point cloud dataset containing the image
     * data \param[in] mask the point data representing the mask that we want to
     * draw \param[in] layer_id the 2D layer ID where we want the extra
     * information to be drawn. \param[in] opacity the opacity of the layer: 0
     * for invisible, 1 for opaque. (default: 0.5)
     */
    template <typename T>
    bool addMask(const typename pcl::PointCloud<T>::ConstPtr& image,
                 const pcl::PointCloud<T>& mask,
     ...
     * \param[in] image the organized point cloud dataset containing the image
     * data \param[in] polygon the point data representing the polygon that we
     * want to draw. A line will be drawn from each point to the next in the
     * dataset. \param[in] r the red channel of the color that the polygon
     * should be rendered with \param[in] g the green channel of the color that
     * the polygon should be rendered with \param[in] b the blue channel of the
     * color that the polygon should be rendered with \param[in] layer_id the 2D
     * layer ID where we want the extra information to be drawn. \param[in]
     * opacity the opacity of the layer: 0 for invisible, 1 for opaque.
     * (default: 1.0)
     */
    template <typename T>
     ...
     * data \param[in] polygon the point data representing the polygon that we
     * want to draw. A line will be drawn from each point to the next in the
     * dataset. \param[in] layer_id the 2D layer ID where we want the extra
     * information to be drawn. \param[in] opacity the opacity of the layer: 0
     * for invisible, 1 for opaque. (default: 1.0)
     */
    template <typename T>
...
protected:
    ...
    /** \brief Convert the Intensity information in a PointCloud<Intensity> to
     * an unsigned char array \param[in] cloud the input cloud containing the
     * grayscale intensity information \param[out] data a boost shared array of
     * unsigned char type \note The method assumes that the data array has
     * already been allocated and contains enough space to copy all the data
     * from cloud!
     */
    ...
    /** \brief Convert the Intensity8u information in a PointCloud<Intensity8u>
     * to an unsigned char array \param[in] cloud the input cloud containing the
     * grayscale intensity information \param[out] data a boost shared array of
     * unsigned char type \note The method assumes that the data array has
     * already been allocated and contains enough space to copy all the data
     * from cloud!
    ...
    /** \brief Convert the RGB information in a PointCloud<T> to an unsigned
     * char array \param[in] cloud the input cloud containing the RGB
     * information \param[out] data a boost shared array of unsigned char type
     * \note The method assumes that the data array has already been allocated
     * and contains enough space to copy all the data from cloud!
     */
    template <typename T>
