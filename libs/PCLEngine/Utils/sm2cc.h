...
public:
     ...
     * @static
     *
     * Converts complete textured mesh including geometry and material
     * definitions.
     */
     ...
     * @param ignoreScalars If true, skip scalar field conversion (default:
     * false)
...
public:
     ...
     * @param ccCloud Target CloudViewer cloud
     * @param overwriteIfExist Overwrite existing field with same name (default:
     * true)
     * @return true on success
     * @static
     *
