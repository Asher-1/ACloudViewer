function( export_VTK_dlls ) # 1 argument: ARGV0 = destination directory
	...
	if( WIN32 AND VTK_DIR )
		...
		if ( NOT (VTK_BINARY_DIR STREQUAL "") )
			...
			file( GLOB vtk_all_dlls ${VTK_BINARY_DIR}/*.dll  )
			
			set (vtk_release_dlls "")
			foreach( filename ${vtk_all_dlls} )
				if( NOT "${filename}" IN_LIST vtk_debug_dlls )
					list( APPEND vtk_release_dlls ${filename})
				endif()
			endforeach()
