...
vtkScalarBarRepresentationCustom::vtkScalarBarRepresentationCustom() {
    this->WindowLocation = vtkScalarBarRepresentationCustom::AnyLocation;
}
...
int vtkScalarBarRepresentationCustom::RenderOverlay(vtkViewport* viewport) {
    ...
    context->DrawRect(xx + boundingRect.GetX(), yy + boundingRect.GetY(),
                      boundingRect.GetWidth(), boundingRect.GetHeight());
    context->End();
    contextDevice->End();
#endif
...
//-----------------------------------------------------------------------------
void vtkScalarBarRepresentationCustom::PrintSelf(ostream& os,
                                                 vtkIndent indent) {
