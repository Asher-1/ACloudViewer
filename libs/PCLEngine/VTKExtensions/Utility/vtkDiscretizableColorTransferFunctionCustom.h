/*=========================================================================
  ...
  Program:   ParaView
  Module:    vtkDiscretizableColorTransferFunctionCustom.h
...
private:
  vtkDiscretizableColorTransferFunctionCustom(const vtkDiscretizableColorTransferFunctionCustom&) = delete;
