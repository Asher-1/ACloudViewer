...
cvStreamlineFilter::cvStreamlineFilter(QWidget* parent) : cvGenericFilter(parent)
{
...
void cvStreamlineFilter::on_integrationDirectionCombo_currentIndexChanged(int index)
{
...
{
	if (Utils::ArrayComparator<double>()(m_sphereCenter, position))
		return;
