...
void QvtkTransformTool::setVisualizer(ecvGenericVisualizer3D* viewer) {
    if (viewer) {
        ...
        if (!m_viewer) {
            CVLog::Warning(
                    "[QvtkTransformTool::setVisualizer] viewer is Null!");
        }
    } else {
...
void QvtkTransformTool::showInteractor(bool state) {
    if (!m_boxWidgetTransformer) {
        CVLog::Warning(
                QString("[QvtkTransformTool::showInteractor] boxWidget has not "
                        "been initialized!"));
        return;
    }
...
void QvtkTransformTool::setTranlationMode(TranslationMOde mode) {
    if (!m_boxWidgetTransformer) {
        CVLog::Warning(
                QString("[QvtkTransformTool::setTranlationMode] boxWidget has "
...
void QvtkTransformTool::setRotationMode(RotationMode mode) {
    if (!m_boxWidgetTransformer) {
        CVLog::Warning(
                QString("[QvtkTransformTool::setRotationMode] boxWidget has "
                        "not been initialized!"));
        return;
    }
...
void QvtkTransformTool::setScaleEnabled(bool state) {
    if (!m_boxWidgetTransformer) {
        CVLog::Warning(
                QString("[QvtkTransformTool::setScaleEnabled] boxWidget has "
                        "not been initialized!"));
        return;
    }
...
void QvtkTransformTool::setShearEnabled(bool state) {
    if (!m_boxWidgetTransformer) {
        CVLog::Warning(
                QString("[QvtkTransformTool::setShearEnabled] boxWidget has "
                        "not been initialized!"));
        return;
    }
