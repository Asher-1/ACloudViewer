...
public:
    ...
    /** \brief Constructor. */
    PclPointCloudColorHandlerLUT() : PointCloudColorHandler<PointT>() {
        capable_ = false;
    }
     ...
     * \param[out] scalars the output scalars containing the color for the
     * dataset \return true if the operation was successful (the handler is
     * capable and the input cloud was given as a valid pointer), false
     * otherwise
     */
