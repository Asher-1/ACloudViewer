...
void PclAnnotationTool::initAnnotationLabels(
...
void PclAnnotationTool::getAnnotationLabels(
...
void PclAnnotationTool::start() {
    if (m_viewer) {
        ...
        connect(m_viewer, &PCLVis::interactorPickedEvent, this,
                &PclAnnotationTool::pickedEventProcess);
        connect(m_viewer, &PCLVis::interactorKeyboardEvent, this,
                &PclAnnotationTool::keyboardEventProcess);
        connect(m_viewer, &PCLVis::interactorAreaPickedEvent, this,
                &PclAnnotationTool::areaPickingEventProcess);
    }
}
...
void PclAnnotationTool::stop() {
    if (m_viewer) {
        ...
        disconnect(m_viewer, &PCLVis::interactorPickedEvent, this,
                   &PclAnnotationTool::pickedEventProcess);
        disconnect(m_viewer, &PCLVis::interactorKeyboardEvent, this,
                   &PclAnnotationTool::keyboardEventProcess);
        disconnect(m_viewer, &PCLVis::interactorAreaPickedEvent, this,
                   &PclAnnotationTool::areaPickingEventProcess);
    }
...
void PclAnnotationTool::areaPickingEventProcess(
...
////////////////////Core processing////////////////////////////
void PclAnnotationTool::filterPickedSlice(const std::vector<int>& inSlices,
...
void PclAnnotationTool::fastLabelCloud(const std::vector<int>& inSlices,
                                       int label) {
...
void PclAnnotationTool::changeAnnotationType(Annotation* anno,
