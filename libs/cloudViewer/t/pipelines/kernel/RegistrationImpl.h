...
template <typename scalar_t>
CLOUDVIEWER_HOST_DEVICE inline bool GetJacobianColoredICP(
...
template <typename scalar_t>
CLOUDVIEWER_HOST_DEVICE inline void PreComputeForDopplerICP(
...
template <typename scalar_t>
CLOUDVIEWER_HOST_DEVICE inline bool GetJacobianDopplerICP(
        const int64_t workload_idx,
        const scalar_t *source_points_ptr,
...
template <typename scalar_t>
CLOUDVIEWER_HOST_DEVICE inline bool GetInformationJacobians(
        int64_t workload_idx,
        const scalar_t *target_points_ptr,
        const int64_t *correspondence_indices,
        scalar_t *jacobian_x,
