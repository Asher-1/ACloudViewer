...
#include "cloudViewer/t/geometry/kernel/MinimumOBB.h"
...
AxisAlignedBoundingBox::AxisAlignedBoundingBox(const core::Tensor &min_bound,
    ...
    if (Volume() < 0) {
        ...
        max_bound_ = cloudViewer::core::Maximum(min_bound, max_bound);
        min_bound_ = cloudViewer::core::Minimum(min_bound, max_bound);
    }
}
...
cloudViewer::geometry::AxisAlignedBoundingBox AxisAlignedBoundingBox::ToLegacy()
        const {
    cloudViewer::geometry::AxisAlignedBoundingBox legacy_box;
    {
        ...
        minc.y = static_cast<PointCoordinateType>(e(1));
        minc.z = static_cast<PointCoordinateType>(e(2));
    }
    {
        Eigen::Vector3d e = core::eigen_converter::TensorToEigenVector3dVector(
...
AxisAlignedBoundingBox AxisAlignedBoundingBox::FromLegacy(
    ...
    Eigen::Vector3d min_b(box.minCorner().x, box.minCorner().y,
                          box.minCorner().z);
