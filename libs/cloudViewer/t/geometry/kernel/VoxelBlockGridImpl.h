...
inline CLOUDVIEWER_DEVICE index_t
...
inline CLOUDVIEWER_DEVICE void DeviceGetNormal(
...
void RayCastCPU
    ...
    core::ParallelFor(device, n, [=] CLOUDVIEWER_DEVICE(index_t workload_idx) {
        auto GetLinearIdxAtP = [&] CLOUDVIEWER_DEVICE(
        ...
        auto GetLinearIdxAtT = [&] CLOUDVIEWER_DEVICE(
...
void ExtractTriangleMeshCPU
    ...
    core::ParallelFor(device, n, [=] CLOUDVIEWER_DEVICE(index_t widx) {
        auto GetLinearIdx = [&] CLOUDVIEWER_DEVICE(
                                    index_t xo, index_t yo, index_t zo,
                                    index_t curr_block_idx) -> index_t {
            return DeviceGetLinearIdx(xo, yo, zo, curr_block_idx,
