...
///
/// (a) CLOUDVIEWER_DATA_ROOT environment variable.
/// (b) $HOME/cloudViewer_data.
...
///   (b) CLOUDVIEWER_DATA_ROOT environment variable.
///   (c) $HOME/cloudViewer_data.
...
/// point clouds of PLY format. This data is used in CloudViewer for
/// Colored-ICP demo.
...
/// in CloudViewer for point cloud crop demo.
/// \copyright Creative Commons 3.0 (CC BY 3.0).
...
/// This data is used in CloudViewer for point cloud feature matching demo.
/// \copyright Creative Commons 3.0 (CC BY 3.0).
...
/// PCD format. This data is used in CloudViewer for ICP demo.
/// \copyright Creative Commons 3.0 (CC BY 3.0).
...
/// fragment pose graph, and global pose graph. This data is used in CloudViewer
