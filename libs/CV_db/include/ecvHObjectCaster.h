...
class CV_DB_LIB_API ccHObjectCaster {
public:
    ...
    /** Warning: if a mesh is passed, this method returns its vertices.
            ...
            \param isLockedVertices the caller can be warned if the returned
    cloud corresponds to locked vertices
    **/
    static ccPointCloud* ToPointCloud(ccHObject* obj,
                                      bool* isLockedVertices = nullptr);

    //! Converts current object to 'equivalent' ccGenericPointCloud
    /** Warning: if a mesh is passed, this method returns its vertices.
     **/
    static ccGenericPointCloud* ToGenericPointCloud(
            ccHObject* obj, bool* isLockedVertices = nullptr);

    //! Converts current object to 'equivalent' ccShiftedObject
    /** Warning: if a mesh is passed, this method returns its vertices.
     **/
    static ccShiftedObject* ToShifted(ccHObject* obj,
                                      bool* isLockedVertices = nullptr);
    ...
    //! Helper: clones the children of sourceEntity and set the resulting
    //! entities as children of destEntity
