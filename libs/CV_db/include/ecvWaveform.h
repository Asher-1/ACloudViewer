...
//! Waveform descriptor
class CV_DB_LIB_API WaveformDescriptor : public ccSerializableObject {
public:
    //! Default constructor
    WaveformDescriptor();
 ...
 **/
class CV_DB_LIB_API ccWaveform : public ccSerializableObject {
public:
    //! Default constructor
 ...
 **/
class CV_DB_LIB_API ccWaveformProxy {
public:
    //! Default constructor
