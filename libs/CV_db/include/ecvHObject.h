...
protected:
    ...
    **/
    ...
    /** Called by 'toFile' (recursive scheme)
        ...
        \param dataVersion target file version for compatibility control
    **/
    ...
    **/
    ...
    //! Returns the minimum file version required to save this instance's own
    //! data
    /** To be overloaded (but still called ;) by subclass.
        Used internally by minimumFileVersion() to compute the overall minimum.
    **/
