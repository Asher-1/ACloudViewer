...
class CV_DB_LIB_API OctreeNodeInfo {
public:
...
class CV_DB_LIB_API OctreeNode : public cloudViewer::utility::IJsonConvertible {
public:
    /// \brief Default Constructor.
    ///
    OctreeNode() {}
...
class CV_DB_LIB_API OctreeInternalNode : public OctreeNode {
public:
    /// \brief Default Constructor.
    ///
...
class CV_DB_LIB_API OctreeInternalPointNode : public OctreeInternalNode {
public:
    /// \brief Default Constructor.
    ///
...
class CV_DB_LIB_API OctreeLeafNode : public OctreeNode {
public:
...
class CV_DB_LIB_API OctreeColorLeafNode : public OctreeLeafNode {
public:
...
/// this leaf node.
class CV_DB_LIB_API OctreePointColorLeafNode : public OctreeColorLeafNode {
public:
    bool operator==(const OctreeLeafNode& other) const override;
    /// Clone this OctreeLeafNode.
    std::shared_ptr<OctreeLeafNode> Clone() const override;
...
class CV_DB_LIB_API Octree : public ccHObject,
...
public:
    ...
    /// points.
    void ConvertFromPointCloud(const ccPointCloud& point_cloud,
