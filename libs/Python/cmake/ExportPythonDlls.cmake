function(export_python_dlls) # 1 argument: ARGV0 = destination directory
    ...
    if (WIN32 AND PYTHON_EXECUTABLE)
        ...
        get_filename_component(CV_PYTHON_DIR ${PYTHON_EXECUTABLE} PATH)
        set(PYTHON_DLL "${CV_PYTHON_DIR}/python${Python3_VERSION_MAJOR}${Python3_VERSION_MINOR}.dll")
		copy_shared_library(${PROJECT_NAME}
			LIB_DIR      ${CV_PYTHON_DIR}
