...
Tensor maybeCopyTensor(const Tensor& data,
                       utility::optional<std::pair<DLDeviceType, int>>
                               optional_dl_device = utility::nullopt,
                       utility::optional<bool> copy = utility::nullopt) {
...
Example:
    ...
    auto to_dlpack = [](const Tensor& tensor,
                        utility::optional<int> stream = utility::nullopt,
                        utility::optional<std::pair<int, int>> max_version =
                                utility::nullopt,
                        utility::optional<std::pair<DLDeviceType, int>>
                                dl_device = utility::nullopt,
                        utility::optional<bool> copy = utility::nullopt) {
        bool versioned =
...
The DLPack capsule shares the tensor's memory.)");
    ...
    tensor.def_static(
            ...
            [from_dlpack_capsule](
                    ...
                    utility::optional<core::Device> device = utility::nullopt,
                    utility::optional<bool> copy = utility::nullopt) {
