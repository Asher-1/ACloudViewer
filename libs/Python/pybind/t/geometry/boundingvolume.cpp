...
void pybind_boundingvolume(py::module& m) {
    ...
    aabb.def(py::init<const core::Device&>(),
            ...
            .def(
                    ...
                    "device_id"_a = 0)
            .def("set_min_bound", &AxisAlignedBoundingBox::SetMinBound,
                 "min_bound"_a)
            .def("set_max_bound", &AxisAlignedBoundingBox::SetMaxBound,
                 "max_bound"_a)
            .def("set_color", &AxisAlignedBoundingBox::SetColor, "color"_a)
            .def_property_readonly("min_bound",
                                   &AxisAlignedBoundingBox::GetMinBound)
            .def_property_readonly("max_bound",
            ...
            .def_static("create_from_points",
                        &AxisAlignedBoundingBox::CreateFromPoints, "points"_a);
    ...
    obb.def(py::init<const core::Device&>(), "device"_a = core::Device("CPU:0"))
            ...
            .def("set_rotation", &OrientedBoundingBox::SetRotation,
                 "rotation"_a)
            ...
            .def("translate", &OrientedBoundingBox::Translate, "translation"_a,
                 "relative"_a = true)
            .def("rotate", &OrientedBoundingBox::Rotate, "rotation"_a,
                 "center"_a = utility::nullopt)
            .def("transform", &OrientedBoundingBox::Transform,
                 "transformation"_a)
            .def("scale", &OrientedBoundingBox::Scale, "scale"_a,
                 "center"_a = utility::nullopt)
