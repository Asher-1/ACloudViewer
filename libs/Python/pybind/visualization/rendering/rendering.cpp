...
void pybind_rendering_classes(py::module &m) {
    ...
    offscreen
            .def(py::init([](int w, int h, const std::string &resource_path,
                 ...
                 "the installed CloudViewer library. By default a running "
                 "windowing "
    ...
    py::class_<Camera, std::shared_ptr<Camera>> cam(m, "Camera",
                                                    "Camera object");
    py::native_enum<Camera::FovType> fov_type(
    ...
    py::native_enum<Camera::Projection> proj_type(
    ...
    py::native_enum<Gradient::Mode> gradient_mode(
            gradient, "Mode", "enum.Enum", "Enum class for Gradient::Mode.");
    ...
    py::native_enum<ColorGradingParams::Quality> cgp_quality(
    ...
    py::native_enum<Scene::GroundPlane> ground_plane(
    ...
    py::native_enum<CloudViewerScene::LightingProfile> lighting(
            o3dscene, "LightingProfile", "enum.Enum",
            "Enum for conveniently setting lighting.");
    lighting.value("HARD_SHADOWS",
