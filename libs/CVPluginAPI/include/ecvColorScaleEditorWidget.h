...
class CVPLUGIN_LIB_API ColorScaleElementSlider : public QWidget,
...
public:
    ...
    static bool IsSmaller(const ColorScaleElementSlider* e1,
...
class CVPLUGIN_LIB_API ColorScaleElementSliders
 ...
 **/
class CVPLUGIN_LIB_API ColorScaleEditorBaseWidget : public QWidget {
    Q_OBJECT
...
public:
    ...
    int length() const {
        return (m_orientation == Qt::Horizontal ? contentsRect().width()
                                                : contentsRect().height()) -
               2 * m_margin;
    }
...
//! Color bar widget
class CVPLUGIN_LIB_API ColorBarWidget : public ColorScaleEditorBaseWidget {
    Q_OBJECT

public:
    //! Default constructor
    ColorBarWidget(SharedColorScaleElementSliders sliders,
                   QWidget* parent = nullptr,
                   Qt::Orientation orientation = Qt::Horizontal);
...
//! All sliders widget
class CVPLUGIN_LIB_API SlidersWidget : public ColorScaleEditorBaseWidget {
    Q_OBJECT

public:
    //! Default constructor
    SlidersWidget(SharedColorScaleElementSliders sliders,
                  QWidget* parent = nullptr,
                  Qt::Orientation orientation = Qt::Horizontal);
    ...
    /** \param relativePos slider position (relatively to scale boundaries
    [0.0,1.0]) \param color slider color \return created slider (pointer on)
    **/
...
class CVPLUGIN_LIB_API SliderLabelWidget : public ColorScaleEditorBaseWidget {
    Q_OBJECT

public:
    //! Default constructor
    SliderLabelWidget(SharedColorScaleElementSliders sliders,
                      QWidget* parent = nullptr,
                      Qt::Orientation orientation = Qt::Horizontal);
...
class CVPLUGIN_LIB_API ccColorScaleEditorWidget
    : public ColorScaleEditorBaseWidget {
    Q_OBJECT

public:
    //! Default constructor
    ccColorScaleEditorWidget(QWidget* parent = nullptr,
                             Qt::Orientation orientation = Qt::Horizontal);
    ...
    inline const ColorScaleElementSlider* getStep(int index) {
        return m_sliders ? m_sliders->at(index) : nullptr;
    }
