...
class CVPLUGIN_LIB_API ColorScaleElementSlider : public QWidget, public ccColorScaleElement
{
	Q_OBJECT
...
class CVPLUGIN_LIB_API ColorScaleElementSliders : public QList<ColorScaleElementSlider*>
{
public:
...
class CVPLUGIN_LIB_API ccColorScaleEditorWidget : public ColorScaleEditorBaseWidget
{
	Q_OBJECT
