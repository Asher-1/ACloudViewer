...
class CVPLUGIN_LIB_API
ecvPS{public : static inline const QString LoadFile(){return "LoadFile";
}
...
static inline const QString CustomLayoutState() { return "customLayoutState"; }
