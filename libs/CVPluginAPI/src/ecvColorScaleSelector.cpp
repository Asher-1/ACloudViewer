...
void ccColorScaleSelector::init() {
    ...
    if (m_comboBox) {
        ...
        // DGM: See doc about qSort --> "An alternative to using qSort() is to
        // put the items to sort in a QMap, using the sort key as the QMap key."
