...
bool ccOverlayDialog::linkWith(QWidget* win)
{
	if (m_processing)
	{
		CVLog::Warning("[ccOverlayDialog] Can't change associated window while running/displayed!");
		return false;
	}
	...
	if (m_associatedWin)
	{
		//we automatically detach the former dialog
		{
			...
			disconnect(m_associatedWin, &QObject::destroyed, this, &ccOverlayDialog::onLinkedWindowDeletion);
...
void ccOverlayDialog::reject()
{
	if (QMessageBox::question(this,
		tr("Quit"), tr("Are you sure you want to quit dialog?"),
