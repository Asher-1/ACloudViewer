...
#include "cloudViewer/pipelines/registration/ColoredICP.h"
#include "cloudViewer/pipelines/registration/Registration.h"
#include "cloudViewer/pipelines/registration/RobustKernel.h"
...
namespace l_reg = cloudViewer::pipelines::registration;
...
TEST_P(RegistrationPermuteDevices, EvaluateRegistration) {
    ...
    for (auto dtype : {core::Float32, core::Float64}) {
        ...
        cloudViewer::geometry::PointCloud source_lpcd = source_tpcd.ToLegacy();
        cloudViewer::geometry::PointCloud target_lpcd = target_tpcd.ToLegacy();
