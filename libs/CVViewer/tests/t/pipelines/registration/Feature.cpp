...
#include "cloudViewer/pipelines/registration/Feature.h"
...
TEST_P(FeaturePermuteDevices, SelectByIndex) {
    ...
    cloudViewer::io::ReadPointCloud(bunny.GetPath(), pcd_legacy);
...
TEST_P(FeaturePermuteDevices, ComputeFPFHFeature) {
    ...
    cloudViewer::io::ReadPointCloud(byunny.GetPath(), pcd_legacy);
