...
#include "cloudViewer/io/PoseGraphIO.h"
...
TEST_P(SLACPermuteDevices, DISABLED_RunSLACOptimizerForFragments) {
    ...
    cloudViewer::pipelines::registration::PoseGraph pose_graph_updated;
    ...
    cloudViewer::camera::PinholeCameraTrajectory trajectory;
