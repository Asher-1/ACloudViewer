...
ViewInterpolate::ViewInterpolate(const ecvViewportParameters& viewParams1, const ecvViewportParameters& m_view2, unsigned int stepCount)
    : m_view1(viewParams1)
    , m_view2(m_view2)
...
bool ViewInterpolate::interpolate(ecvViewportParameters& interpView, double interpolate_fraction) const
{
