...
public:
    ...
    **/
    ...
    struct SF2 {
        SF2() : isConstantValue(true), constantValue(0), sfIndex(-1) {}
    ...
    /** \param cloud cloud on which to apply the SF operation
            ...
            \param inplace whether the operation should be applied in place
    (SF1). Otherwise a new SF will be created. \param sf2 secondary scalar field
    / value (only for PLUS, MINUS, MULTIPLY and DIVIDE operations) \param parent
    parent widget (optional) \return success
    **/
