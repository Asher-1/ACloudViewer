...
class ecvFilterByLabelDlg : public ccOverlayDialog, public Ui::FilterByLabelDialog
{
	Q_OBJECT
...
protected slots:
	...
	void onSplit() { m_mode = SPLIT; apply(); }
	void onExportSelected() { m_mode = EXPORT_SELECTED; apply(); }
	void onExportUnSelected() { m_mode = EXPORT_UNSELECTED; apply(); }
