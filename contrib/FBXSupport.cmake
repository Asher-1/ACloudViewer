# ------------------------------------------------------------------------------
# Autodesk FBX support for ErowCloudViewer
# ------------------------------------------------------------------------------
...
if(OPTION_USE_FBX_SDK)
	...
	# FBX SDK
	set( FBX_SDK_INCLUDE_DIR "contrib/FBX-2020.0.1/include" CACHE PATH "FBX SDK include directory" )
	set( FBX_SDK_LIBRARY_FILE "${CMAKE_CURRENT_SOURCE_DIR}/contrib/FBX-2020.0.1/lib/X64/release/libfbxsdk.lib" CACHE FILEPATH "FBX SDK static library file" )
	set( FBX_XML2_LIBRARY_FILE "${CMAKE_CURRENT_SOURCE_DIR}/contrib/FBX-2020.0.1/lib/X64/release/libxml2-md.lib" CACHE FILEPATH "FBX XML2 static library file (for the 2019 SDK only)" )

	if( CMAKE_CONFIGURATION_TYPES )
		set( FBX_SDK_LIBRARY_FILE_DEBUG "${CMAKE_CURRENT_SOURCE_DIR}/contrib/FBX-2020.0.1/lib/X64/debug/libfbxsdk.lib" CACHE FILEPATH "FBX SDK static debug library file" )
		set( FBX_XML2_LIBRARY_FILE_DEBUG "${CMAKE_CURRENT_SOURCE_DIR}/contrib/FBX-2020.0.1/lib/X64/debug/libxml2-md.lib" CACHE FILEPATH "FBX XML2 static debug library file (for the 2019 SDK only)" )
	endif()
...
if( ${OPTION_USE_FBX_SDK} )
	...
	if( FBX_SDK_LIBRARY_FILE )
		...
		if ( CMAKE_CONFIGURATION_TYPES )
			set_property( TARGET ${ARGV0} APPEND PROPERTY COMPILE_DEFINITIONS_RELEASE CV_FBX_SUPPORT )
			target_link_libraries( ${ARGV0} optimized ${FBX_SDK_LIBRARY_FILE} )
		else()
			set_property( TARGET ${ARGV0} APPEND PROPERTY COMPILE_DEFINITIONS CV_FBX_SUPPORT )
	...
	if ( CMAKE_CONFIGURATION_TYPES )
		...
		if (FBX_SDK_LIBRARY_FILE_DEBUG)
			...
			set_property( TARGET ${ARGV0} APPEND PROPERTY COMPILE_DEFINITIONS_DEBUG CV_FBX_SUPPORT )
