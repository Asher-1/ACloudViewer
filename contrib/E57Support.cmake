# ------------------------------------------------------------------------------
# libE57Format+CMake support for ErowCloudViewer
# ------------------------------------------------------------------------------
...
if( ${OPTION_USE_LIBE57FORMAT} )
	# libE57Format
	set( LIBE57FORMAT_INSTALL_DIR "contrib/E57Format-2.1" CACHE PATH "libE57Format install directory (CMAKE_INSTALL_PREFIX from libE57Format)" )
	...
	# Find Xerces
	if (WIN32)
		set( Xerces_INCLUDE_DIR "contrib/xerces-c-3.2.0/include" CACHE PATH "Xerces include directory" )
		
		# ensure we can find at least one of the libs
		set( XERCES_LIB_DIR "contrib/xerces-c-3.2.0/lib" CACHE INTERNAL "" )
		...
		#set( Xerces_LIBRARY_RELEASE "contrib/xerces-c-3.2.0/lib/xerces-c_3.lib" CACHE FILEPATH "Xerces (release) library file" )
 		#if( CMAKE_CONFIGURATION_TYPES )
			#set( Xerces_LIBRARY_DEBUG "contrib/xerces-c-3.2.0/lib/xerces-c_3D.lib" CACHE FILEPATH "Xerces (debug) library file" )
		#endif()
	else ()
		include(FindXercesC)
