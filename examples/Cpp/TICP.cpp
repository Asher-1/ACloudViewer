...
public:
    RegistrationWindow(const core::Device& device)
        : gui::Window("CloudViewer - Registration", 1280, 800),
          device_(device),
...
private:
    ...
    cloudViewer::visualization::rendering::MaterialRecord src_cloud_mat_;
    cloudViewer::visualization::rendering::MaterialRecord tar_cloud_mat_;
    // For Visualization.
