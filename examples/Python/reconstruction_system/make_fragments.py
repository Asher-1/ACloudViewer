...
def make_posegraph_for_fragment(path_dataset, sid, eid, color_files,
    ...
    pose_graph.nodes.append(cv3d.pipelines.registration.PoseGraphNode(trans_odometry))
    for s in range(sid, eid):
        for t in range(s + 1, eid):
            ...
            if t == s + 1:
                ...
                pose_graph.nodes.append(cv3d.pipelines.registration.PoseGraphNode(trans_odometry_inv))
