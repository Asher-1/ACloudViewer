...
class PoseGraphWrapper:
    ...
    def __init__(self, dict_nodes=None, dict_edges=None):
        ...
        self.pose_graph = cv3d.pipelines.registration.PoseGraph()
    ...
    def _dicts2graph(self):
        ...
        for i in range(n_nodes):
            ...
            pose_graph.nodes.append(
                cv3d.pipelines.registration.PoseGraphNode(self.dict_nodes[k]))
    ...
    def load(fname):
        ...
        # Load pose graph
        ans.pose_graph = cv3d.io.read_pose_graph(fname)
    ...
    def save(self, fname):
        self.pose_graph = self._dicts2graph()
        cv3d.io.write_pose_graph(fname, self.pose_graph)
