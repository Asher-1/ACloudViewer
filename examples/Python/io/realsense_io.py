...
import cloudViewer.t.io as io3d
from cloudViewer.t.geometry import PointCloud
...
def point_cloud_video(executor, rgbd_frame, mdata, timestamp, o3dvis):
    ...
    if point_cloud_video.fid == 0:
        ...
        pcd = PointCloud(cv3d.core.Tensor.zeros((max_pts, 3)))
    ...
    with ThreadPoolExecutor(max_workers=4) as executor:
        ...
        if have_bag:
            ...
            executor.submit(pcd_video_from_bag,
                            cv3d.data.JackJackL515Bag().path, executor, o3dvis)
